...
-1 != navigator.appVersion.indexOf("MSIE") && document.documentMode
...
document.attachEvent
		&& (AmCharts.isNN = !1, AmCharts.isIE = !0, 9 > AmCharts.IEversion
				&& (AmCharts.dx = 0, AmCharts.dy = 0));
...
AmCharts.isNN
		&& (document
				.addEventListener("mousemove", AmCharts.handleMouseMove, !0), window
				.addEventListener("resize", AmCharts.handleResize, !0), document
				.addEventListener("mouseup", AmCharts.handleMouseUp, !0), window
				.addEventListener("load", AmCharts.handleLoad, !0));
AmCharts.isIE
		&& (document.attachEvent("onmousemove", AmCharts.handleMouseMove), window
				.attachEvent("onresize", AmCharts.handleResize), document
				.attachEvent("onmouseup", AmCharts.handleMouseUp), window
				.attachEvent("onload", AmCharts.handleLoad));
AmCharts.clear = function() {
	...
	AmCharts.isNN
			&& (document.removeEventListener("mousemove",
					AmCharts.handleMouseMove, !0), window.removeEventListener(
					"resize", AmCharts.handleResize, !0), document
					.removeEventListener("mouseup", AmCharts.handleMouseUp, !0), window
					.removeEventListener("load", AmCharts.handleLoad, !0));
	AmCharts.isIE
			&& (document.detachEvent("onmousemove", AmCharts.handleMouseMove), window
					.detachEvent("onresize", AmCharts.handleResize), document
					.detachEvent("onmouseup", AmCharts.handleMouseUp), window
					.detachEvent("onload", AmCharts.handleLoad))
};
AmCharts.AmChart = AmCharts.Class({
	...
	drawBackground : function() {
		...
		var a = this.container, b = this.backgroundColor, d = this.backgroundAlpha, e = this.set, f = this
				.updateWidth();
		this.realWidth = f;
		var g = this.updateHeight();
		this.realHeight = g;
		this.background = b = AmCharts.polygon(a, [0, f - 1, f - 1, 0], [0, 0,
						g - 1, g - 1], b, d, 1, this.borderColor,
				this.borderAlpha);
		e.push(b);
		if (b = this.backgroundImage)
			this.path && (b = this.path + b), this.bgImg = a = a.image(b, 0, 0,
					f, g), e.push(a)
	},
	drawTitles : function() {
		var a = this.titles;
	...
	initChart : function() {
		...
		if (b && window.getComputedStyle
			...
			this.dmouseY = AmCharts.removePx(b.getPropertyValue("margin-top")), this.dmouseX = AmCharts
					.removePx(b.getPropertyValue("margin-left"));
		this.mouseMode = a;
		this.container = new AmCharts.AmDraw(this.chartDiv, this.realWidth,
				this.realHeight);
		if (AmCharts.VML || AmCharts.SVG)
			a = this.container, this.set = a.set(), this.gridSet = a.set(), this.graphsBehindSet = a
					.set(), this.bulletBehindSet = a.set(), this.columnSet = a
					.set(), this.graphsSet = a.set(), this.trendLinesSet = a
					.set(), this.axesLabelsSet = a.set(), this.axesSet = a
					.set(), this.cursorSet = a.set(), this.scrollbarsSet = a
					.set(), this.bulletSet = a.set(), this.freeLabelsSet = a
					.set(), this.balloonsSet = a.set(), this.balloonsSet
					.setAttr("id", "balloons"), this.zoomButtonSet = a.set(), this.linkSet = a
					.set(), this.drb(), this.renderFix()
	},
	measure : function() {
		...
		var g = AmCharts.removePx(AmCharts.getStyle(a, "padding-left")), h = AmCharts
				.removePx(AmCharts.getStyle(a, "padding-right")), j = AmCharts
				.removePx(AmCharts.getStyle(a, "padding-top")), k = AmCharts
				.removePx(AmCharts.getStyle(a, "padding-bottom"));
		isNaN(g) || (d -= g);
		isNaN(h) || (d -= h);
		isNaN(j) || (e -= j);
		isNaN(k) || (e -= k);
		...
		if (a != this.previousWidth || g != this.previousHeight)
			b.style.width = a + "px", b.style.height = g + "px", f
					&& f.setSize(a, g), this.balloon.setBounds(2, 2, a - 2, g);
		this.realWidth = a;
		this.realHeight = g;
		this.divRealWidth = d;
	...
	clear : function(a) {
		...
		this.clearTimeOuts();
		this.container
				&& (this.container.remove(this.chartDiv), this.container
						.remove(this.legendDiv));
	...
	drawLabel : function(a) {
		if (this.container) {
			var b = a.y, d = a.text, e = a.align, f = a.size, g = a.color, h = a.rotation, j = a.alpha, k = a.bold, l = AmCharts
					.toCoordinate(a.x, this.realWidth), b = AmCharts
					.toCoordinate(b, this.realHeight);
			l || (l = 0);
			b || (b = 0);
			...
			"center" == e
					&& (e = "middle", h
							? b = this.realHeight - b + b / 2
							: l = this.realWidth / 2 - l);
			void 0 === j && (j = 1);
			void 0 === h && (h = 0);
			b += f / 2;
			d = AmCharts
					.text(this.container, d, g, this.fontFamily, f, e, k, j);
			d.translate(l, b);
			0 !== h && d.rotate(h);
	...
	updateWidth : function() {
		...
		if (d) {
			...
			if ("right" == d || "left" == d)
				a -= f, 0 > a && (a = 0), h.width = a + "px", "left" == d
						? h.left = f + "px"
						: e.left = a + "px", e.top = (b - g) / 2 + "px"
		}
		return a
	},
	...
	dispDUpd : function() {
		...
		this.dispatchDataUpdated
				&& (this.dispatchDataUpdated = !1, a = "dataUpdated", this
						.fire(a, {
									type : a,
									chart : this
								}));
	...
	drb : function() {
		var a = this.product, b = a + ".com", d = window.location.hostname
				.split("."), e;
		2 <= d.length && (e = d[d.length - 2] + "." + d[d.length - 1]);
		AmCharts.remove(this.bbset);
		if (e != b) {
			var b = b + "/?utm_source=swf&utm_medium=demo&utm_campaign=jsDemo"
					+ a, f = "chart by ", d = 145;
			"ammap" == a && (f = "tool by ", d = 125);
			e = AmCharts.rect(this.container, d, 20, "#FFFFFF", 1);
			f = AmCharts.text(this.container, f + a + ".com", "#000000",
					"Verdana", 11, "start");
			f.translate(7, 9);
	...
	validateData : function(a) {
		this.chartCreated
				&& (this.dataChanged = !0, this.marginsUpdated = !1, this
						.initChart(a))
	},
	...
	showBalloonReal : function(a, b, d, e, f) {
		...
		var g = this.balloon;
		g.enabled
				&& (g.followCursor(!1), g.changeColor(b), d
						|| g.setPosition(e, f), g.followCursor(d), a
						&& g.showBalloon(a))
	},
	handleTouchMove : function(a) {
		...
		var b = this.chartDiv;
		a.touches
				&& (a = a.touches.item(0), this.mouseX = a.pageX
						- AmCharts.findPosX(b), this.mouseY = a.pageY
						- AmCharts.findPosY(b))
	},
		...
		if (this.mouseIsOver) {
			...
			if (a) {
				...
				switch (this.mouseMode) {
					...
					case 0 :
						this.divIsFixed
								? (d = a.clientX - this.posX, e = a.clientY
										- this.posY)
								: (d = a.pageX - this.posX, e = a.pageY
										- this.posY)
				}
	...
	addLegend : function(a, b) {
		...
		a.chart = this;
		d
				? (a.div = d, a.position = "outside", a.autoMargins = !1)
...
AmCharts.toCoordinate = function(a, b, d) {
	var e;
	void 0 !== a
			&& (a = String(a), d && d < b && (b = d), e = Number(a), -1 != a
					.indexOf("!")
					&& (e = b - Number(a.substr(1))), -1 != a.indexOf("%")
...
AmCharts.resetDateToMin = function(a, b, d, e) {
	void 0 === e && (e = 1);
	var f = a.getFullYear(), g = a.getMonth(), h = a.getDate(), j = a
			.getHours(), k = a.getMinutes(), l = a.getSeconds(), m = a
			.getMilliseconds();
	a = a.getDay();
	switch (b) {
		case "YYYY" :
...
AmCharts.getMaxInterval = function(a, b) {
	...
	return a >= d[b].contains
			? (a = Math.round(a / d[b].contains), b = d[b].nextInterval, AmCharts
					.getMaxInterval(a, b))
			: "ss" == b ? d[b].nextInterval : b
};
AmCharts.formatDuration = function(a, b, d, e, f, g) {
	...
	if (a >= h[b].contains) {
		...
		"ss" == b
				&& (k = AmCharts.formatNumber(k, g), 1 == k.split(j)[0].length
						&& (k = "0" + k));
		if (("mm" == b || "hh" == b) && 10 > k)
			k = "0" + k;
		d = k + "" + e[b] + "" + d;
	...
	"ss" == b
			&& (a = AmCharts.formatNumber(a, g), 1 == a.split(j)[0].length
					&& (a = "0" + a));
	if (("mm" == b || "hh" == b) && 10 > a)
		a = "0" + a;
	d = a + "" + e[b] + "" + d;
...
AmCharts.formatNumber = function(a, b, d, e, f) {
	...
	if (k)
		...
		for (m = k.length; 0 <= m; m -= 3)
			l = m != k.length ? 0 !== m ? k.substring(m - 3, m) + b + l : k
					.substring(m - 3, m)
					+ l : k.substring(m - 3, m);
		void 0 !== j[1] && (l = l + g + j[1]);
		void 0 !== d && (0 < d && "0" != l)
				&& (l = AmCharts.addZeroes(l, g, d))
	}
	l = h + l;
	"" === h && (!0 === e && 0 !== a) && (l = "+" + l);
	!0 === f && (l += "%");
...
AmCharts.addZeroes = function(a, b, d) {
	...
	return a[1].length < d ? (a[1] += "0", AmCharts.addZeroes(a[0] + b + a[1],
			b, d)) : void 0 !== a[1] ? a[0] + b + a[1] : a[0]
};
...
AmCharts.isInRectangle = function(a, b, d) {
	return a >= d.x - 5 && a <= d.x + d.width + 5 && b >= d.y - 5
			&& b <= d.y + d.height + 5 ? !0 : !1
};
...
AmCharts.formatDate = function(a, b) {
	var d, e, f, g, h, j, k, l;
	AmCharts.useUTC
			? (d = a.getUTCFullYear(), e = a.getUTCMonth(), f = a.getUTCDate(), g = a
					.getUTCDay(), h = a.getUTCHours(), j = a.getUTCMinutes(), k = a
					.getUTCSeconds(), l = a.getUTCMilliseconds())
			: (d = a.getFullYear(), e = a.getMonth(), f = a.getDate(), g = a
					.getDay(), h = a.getHours(), j = a.getMinutes(), k = a
					.getSeconds(), l = a.getMilliseconds());
...
AmCharts.findIfAuto = function(a) {
	return a.style && "auto" == AmCharts.getStyle(a, "overflow")
			? !0
			: a.parentNode ? AmCharts.findIfAuto(a.parentNode) : !1
};
...
AmCharts.formatValue = function(a, b, d, e, f, g, h, j) {
	if (b) {
		...
		for (k = 0; k < d.length; k++) {
			var l = d[k], m = b[l];
			void 0 !== m
					&& (m = g ? AmCharts.addPrefix(m, j, h, e) : AmCharts
							.formatNumber(m, e), a = a.replace(RegExp("\\[\\["
											+ f + "" + l + "\\]\\]", "g"), m))
		}
	}
	return a
...
AmCharts.copyProperties = function(a, b) {
	for (var d in a)
		a.hasOwnProperty(d) && "events" != d
				&& (void 0 !== a[d] && "function" != typeof a[d])
				&& (b[d] = a[d])
};
...
AmCharts.fixNewLines = function(a) {
	9 > AmCharts.IEversion && 0 < AmCharts.IEversion
		...
		if (0 != b)
			if ("[object Array]" === Object.prototype.toString.call(a))
				for (var d = 0; d < a.length; d++)
					AmCharts.deleteObject(a[d], b - 1), a[d] = null;
			else
				try {
					for (d in a)
						a[d]
								&& ("object" == typeof a[d]
										&& AmCharts.deleteObject(a[d], b - 1), "function" != typeof a[d]
										&& (a[d] = null))
				} catch (e) {
				}
	}
...
AmCharts.Bezier = AmCharts.Class({
	...
	interpolate : function(a) {
		...
		for (h = 1; h < a.length - 1; h++) {
			var j = a[h - 1], k = a[h], e = a[h + 1], d = e.x - k.x, e = e.y
					- j.y, j = k.x - j.x;
			j > d && (j = d);
			b.push({
						x : k.x - j / f,
	...
	drawBeziers : function(a) {
		...
		for (d = 0; d < (a.length - 1) / 3; d++)
			b += this.drawBezierMidpoint(a[3 * d], a[3 * d + 1], a[3 * d + 2],
					a[3 * d + 3]);
		return b
	},
	drawBezierMidpoint : function(a, b, d, e) {
		var f = Math.round, g = this.getPointOnSegment(a, b, 0.75), h = this
				.getPointOnSegment(e, d, 0.75), j = (e.x - a.x) / 16, k = (e.y - a.y)
				/ 16, l = this.getPointOnSegment(a, b, 0.375);
...
AmCharts.Cuboid = AmCharts.Class({
	...
	draw : function() {
		var a = this.set;
		a.clear();
		var b = this.container, d = this.w, e = this.h, f = this.dx, g = this.dy, h = this.colors, j = this.alpha, k = this.bwidth, l = this.bcolor, m = this.balpha, n = this.gradientRotation, s = this.cornerRadius, p = h, r = h;
		"object" == typeof h && (p = h[0], r = h[h.length - 1]);
		var q, u, t, v, w, y, x, z, C;
		if (0 < f || 0 < g)
			x = r, r = AmCharts.adjustLuminosity(p, -0.2), r = AmCharts
					.adjustLuminosity(p, -0.2), q = AmCharts.polygon(b, [0, f,
							d + f, d, 0], [0, g, g, 0, 0], r, j, 0, 0, 0, n), 0 < m
					&& (C = AmCharts.line(b, [0, f, d + f], [0, g, g], l, m, k)), u = AmCharts
					.polygon(b, [0, 0, d, d, 0], [0, e, e, 0, 0], r, j, 0, 0,
							0, 0, n), u.translate(f, g), 0 < m
					&& (t = AmCharts.line(b, [f, f], [g, g + e], l, 1, k)), v = AmCharts
					.polygon(b, [0, 0, f, f, 0], [0, e, e + g, g, 0], r, j, 0,
							0, 0, n), w = AmCharts.polygon(b, [d, d, d + f,
							d + f, d], [0, e, e + g, g, 0], r, j, 0, 0, 0, n), 0 < m
					&& (y = AmCharts.line(b, [d, d + f, d + f, d], [0, g,
									e + g, e], l, m, k)), r = AmCharts
					.adjustLuminosity(x, 0.2), x = AmCharts.polygon(b, [0, f,
							d + f, d, 0], [e, e + g, e + g, e, e], r, j, 0, 0,
					0, n), 0 < m
					&& (z = AmCharts.line(b, [0, f, d + f], [e, e + g, e + g],
							l, m, k));
		1 > Math.abs(e) && (e = 0);
		1 > Math.abs(d) && (d = 0);
		b = 0 === e ? AmCharts.line(b, [0, d], [0, 0], p, m, k) : 0 === d
				? AmCharts.line(b, [0, 0], [0, e], p, m, k)
				: 0 < s
						? AmCharts.rect(b, d, e, h, j, k, l, m, s, n)
						: AmCharts.polygon(b, [0, 0, d, d, 0], [0, e, e, 0, 0],
								h, j, k, l, m, n);
		e = 0 > e ? [q, C, u, t, v, w, y, x, z, b] : [x, z, u, t, v, w, q, C,
				y, b];
	...
	updateWidth : function() {
		...
		var b = a.totalFrames;
		a.frame <= b
				&& (b = a.easing(0, a.frame, 1, a.rw - 1, b), a.width(b), setTimeout(
						function() {
...
AmCharts.AmLegend = AmCharts.Class({
	...
	drawLegend : function() {
		...
		"outside" == b
				? (d = g.offsetWidth, f = g.offsetHeight, g.clientHeight
						&& (d = g.clientWidth, f = g.clientHeight))
				: (g.style.width = d + "px", g.className = "amChartsLegend");
		this.divWidth = d;
		...
		this.titleWidth = 0;
		if (b = this.title)
			a = AmCharts.text(this.container, b, this.color, a.fontFamily,
					this.fontSize, "start", !0), a.translate(0, this.marginTop
							+ this.verticalGap + this.ly + 1), a = a.getBBox(), this.titleWidth = a.width
					+ 15, this.titleHeight = a.height + 6;
	...
	arrangeEntries : function() {
		var a = this.position, b = this.marginLeft + this.titleWidth, d = this.marginRight, e = this.marginTop, f = this.marginBottom, g = this.horizontalGap, h = this.div, j = this.divWidth, k = this.maxColumns, l = this.verticalGap, m = this.spacing, n = j
				- d - b, s = 0, p = 0, r = this.container, q = r.set();
		this.set = q;
		r = r.set();
		q.push(r);
		...
		for (v = 0; v < u.length; v++) {
			...
			var C;
			this.equalWidths
					? C = g + y * (s + m + this.markerLabelGap)
					: (C = x, x = x + t.width + g + m);
			C + t.width > n && 0 < v
					&& (w++, y = 0, C = g, x = C + t.width + g + m);
			z.translate(C, (p + l) * w);
			y++;
			!isNaN(k) && y >= k && (y = 0, w++);
			r.push(z)
		...
		t = r.getBBox();
		k = t.height + 2 * l - 1;
		"left" == a || "right" == a ? (j = t.width + 2 * g, h.style.width = j
				+ b + d + "px") : j = j - b - d - 1;
		d = AmCharts.polygon(this.container, [0, j, j, 0], [0, 0, k, k],
		...
		if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
			"center" == this.align
					? b = g + (j - t.width) / 2
					: "right" == this.align && (b = g + j - t.width);
		r.translate(b, l + 1);
	...
	createEntry : function(a) {
		if (!1 !== a.visibleInLegend) {
			...
			if (h) {
				...
				j.dItem = a;
				!0 !== a.hidden ? "x" == h ? j.hide() : j.show() : "x" != h
						&& j.hide();
			...
			h = this.color;
			a.showBalloon
					&& (this.textClickEnabled && void 0 !== this.selectedColor)
			...
			var e = AmCharts.massReplace(this.labelText, {
						"[[title]]" : a.title
					}), k = this.fontSize, l = this.markerSize;
			if (g && l <= k) {
				var m = 0;
			...
			var n;
			e
					&& (n = AmCharts.text(this.container, e, h, b.fontFamily,
							k, "start"), n.translate(this.lx, this.ly), f
							.push(n), b = n.getBBox().width, this.maxLabelWidth < b
	...
	clickMarker : function(a) {
		this.switchable ? !0 === a.hidden ? this.dispatch("showItem", a) : this
				.dispatch("hideItem", a) : this.textClickEnabled
				&& this.dispatch("clickMarker", a)
	},
	rollOverLabel : function(a) {
		a.hidden
				|| (this.textClickEnabled && a.legendLabel
						&& a.legendLabel.attr({
	...
	rollOutLabel : function(a) {
		if (!a.hidden) {
			if (this.textClickEnabled && a.legendLabel) {
				var b = this.color;
				void 0 !== this.selectedColor && a.showBalloon
	...
	createValue : function(a) {
		...
		if (!1 !== a.visibleInLegend) {
			...
			if (b.valueText) {
				...
				var h = b.valueText, e = e + b.lx + b.markerLabelGap
						+ b.valueWidth, j = "end";
			...
			d = b.container
					.rect(b.markerSize + b.markerLabelGap, 0, f, g, 0, 0).attr(
							{
								stroke : "none",
								fill : "#FFFFFF",
								"fill-opacity" : 0.005
	...
	createV : function() {
		...
		return AmCharts.polygon(this.container,
				[a / 5, a / 2, a - a / 5, a / 2], [a / 3, a - a / 5, a / 5,
						a / 1.7], this.switchColor)
	},
	createX : function() {
		var a = this.markerSize - 3, b = {
			stroke : this.switchColor,
			"stroke-width" : 3
		}, d = this.container, e = AmCharts.line(d, [3, a], [3, a]).attr(b), a = AmCharts
				.line(d, [3, a], [a, 3]).attr(b);
	...
	createMarker : function(a, b, d) {
		...
		switch (a) {
			case "square" :
				g = AmCharts.polygon(f, [0, e, e, 0], [0, 0, e, e], b, d, j, h,
						k);
				break;
			case "circle" :
			...
			case "dashedLine" :
				...
				break;
			case "triangleUp" :
				g = AmCharts.polygon(f, [0, e / 2, e, e], [e, 0, e, e], b, d,
						j, h, k);
				break;
			case "triangleDown" :
				g = AmCharts.polygon(f, [0, e / 2, e, e], [0, e, 0, 0], b, d,
						j, h, k);
				break;
			case "bubble" :
...
AmCharts.AmBalloon = AmCharts.Class({
	...
	draw : function() {
		var a = this.pointToX, b = this.pointToY, d = this.textAlign;
		if (!isNaN(a)) {
			...
			if (this.show) {
				...
				var r = this.horizontalPadding, n = this.verticalPadding, q = this.pointerWidth, u = this.pointerOrientation, t = this.cornerRadius, v = e.fontFamily, w = this.fontSize;
				...
				void 0 != m
						&& (y = AmCharts
								.text(f, this.text, m, v, w, d, !1, 0.4), g
								.push(y));
				v = e.getBBox();
				m = v.height + 2 * n;
				v = v.width + 2 * r;
				...
				"H" != u
						? (x = a - v / 2, d = b < j + m + 10 && "down" != u ? b
								+ q : b - m - q)
						: (2 * q > m && (q = m / 2), d = b - m / 2, x = a < h
								+ (k - h) / 2 ? a + q : a - v - q);
				d + m >= l && (d = l - m);
				d < j && (d = j);
				x < h && (x = h);
				x + v > k && (x = k - v);
				0 < t || 0 === q
						? (p = AmCharts.rect(f, v, m, s, this.fillAlpha,
								this.borderThickness, p, this.borderAlpha,
								this.cornerRadius), this.showBullet
								&& (f = AmCharts.circle(f, this.bulletSize, s,
										this.fillAlpha), f.translate(a, b), this.pointer = f))
						: (l = [], t = [], "H" != u
								? (h = a - x, h > v - q && (h = v - q), h < q
										&& (h = q), l = [0, h - q, a - x,
										h + q, v, v, 0, 0], t = b < j + m + 10
										&& "down" != u ? [0, 0, b - d, 0, 0, m,
										m, 0] : [m, m, b - d, m, m, 0, 0, m])
								: (j = b - d, j > m - q && (j = m - q), j < q
										&& (j = q), t = [0, j - q, b - d,
										j + q, m, m, 0, 0], l = a < h + (k - h)
										/ 2 ? [0, 0, x < a ? 0 : a - x, 0, 0,
										v, v, 0] : [v, v,
										x + v > a ? v : a - x, v, v, 0, 0, v]), p = AmCharts
								.polygon(f, l, t, s, this.fillAlpha,
										this.borderThickness, p,
										this.borderAlpha));
				g.push(p);
				p.toFront();
				y && y.toFront();
		...
		if (this.follow && this.show) {
			...
			if (a != this.previousX || b != this.previousY)
				if (this.previousX = a, this.previousY = b, 0 === this.cornerRadius)
					...
					var d = this.set;
					if (d) {
						var e = d.getBBox(), a = a - e.width / 2, f = b
								- e.height - 10;
						a < this.l && (a = this.l);
	...
	followCursor : function(a) {
		...
		!isNaN(d)
				&& a
				&& (b.pointToX = d, b.pointToY = e - 3, b.interval = setInterval(
						function() {
...
AmCharts.AmCoordinateChart = AmCharts.Class({
	...
	construct : function() {
		...
		this
				.createEvents("rollOverGraphItem", "rollOutGraphItem",
						"clickGraphItem", "doubleClickGraphItem",
						"rightClickGraphItem");
	...
	parseSerialData : function() {
		...
		if (f) {
			var g = !1;
			if (b = this.categoryAxis)
				var g = b.parseDates, h = b.forceShowField;
			var j, k;
			g
					&& (j = AmCharts.extractPeriod(b.minPeriod), k = j.period, j = j.count);
			var l = {};
			this.lookupTable = l;
			var m;
			for (m = 0; m < f.length; m++) {
				...
				l[s[e]] = n;
				g
						&& (b = isNaN(b) ? new Date(b.getFullYear(), b
										.getMonth(), b.getDate(), b.getHours(),
								b.getMinutes(), b.getSeconds(), b
										.getMilliseconds()) : new Date(b), b = AmCharts
								.resetDateToMin(b, k, j), n.category = b, n.time = b
								.getTime());
		...
		for (d = 0; d < a.length; d++)
			b = a[d], b.dataProvider && this.parseGraphData(b)
	},
	...
	parseGraphData : function(a) {
		...
		for (e = 0; e < b.length; e++) {
			...
			g
					&& (h = g.axes[h].graphs[a.id], h.serialDataItem = g, h.values = this
							.processValues(f, a, a.periodValue), this
							.processFields(a, h, f))
		}
	},
	...
	formatString : function(a, b) {
		...
		e.duration
				&& b.values.value
				&& (e = AmCharts.formatDuration(b.values.value, e.duration, "",
						e.durationUnits, e.maxInterval, e.numberFormatter), a = a
						.split("[[value]]").join(e));
		a = AmCharts.massReplace(a, {
					"[[title]]" : d.title,
	...
	processFields : function(a, b, d) {
		...
		e = "lineColor color alpha fillColors description bullet customBullet bulletSize bulletConfig url labelColor"
				.split(" ");
	...
	chooseGraphColor : function(a, b) {
		if (void 0 == a.lineColor) {
			var d;
			d = this.colors.length > b ? this.colors[b] : AmCharts
					.randomColor();
			a.lineColor = d
		}
	},
...
AmCharts.AmRectangularChart = AmCharts.Class({
	...
	resetMargins : function() {
		...
		if ("serial" == this.chartType) {
			...
			for (b = 0; b < d.length; b++) {
				var e = d[b];
				e.ignoreAxisWidth
						|| (e.setOrientation(this.rotate), e.fixAxisPosition(), a[e.position] = !0)
			}
			if ((b = this.categoryAxis) && !b.ignoreAxisWidth)
				b.setOrientation(!this.rotate), b.fixAxisPosition(), b
						.fixAxisPosition(), a[b.position] = !0
		} else {
			e = this.xAxes;
			d = this.yAxes;
			...
			for (b = 0; b < d.length; b++)
				e = d[b], e.ignoreAxisWidth
						|| (e.setOrientation(!1), e.fixAxisPosition(), a[e.position] = !0)
		}
	...
	measureMargins : function() {
		var a = this.valueAxes, b, d = this.autoMarginOffset, e = this.fixMargins, f = this.realWidth, g = this.realHeight, h = d, j = d, k = f
				- d;
		b = g - d;
		var l;
		for (l = 0; l < a.length; l++)
			b = this.getAxisBounds(a[l], h, k, j, b), h = b.l, k = b.r, j = b.t, b = b.b;
		if (a = this.categoryAxis)
			b = this.getAxisBounds(a, h, k, j, b), h = b.l, k = b.r, j = b.t, b = b.b;
		e.left && h < d && (this.marginLeft = Math.round(-h + d));
		e.right && k > f - d && (this.marginRight = Math.round(k - f + d));
		e.top
				&& j < d + this.titleHeight
				&& (this.marginTop = Math.round(this.marginTop - j + d
						+ this.titleHeight));
	...
	drawZoomOutButton : function() {
		...
		d = AmCharts.text(a.container, a.zoomOutText, d, a.fontFamily, e,
				"start");
		e = d.getBBox();
		d.translate(29, 6 + e.height / 2);
		f = AmCharts.rect(a.container, e.width + 40, e.height + 15,
				f.backgroundColor, f.backgroundAlpha);
		b.push(f);
		a.zbBG = f;
		void 0 !== a.pathToImages
				&& (f = a.container.image(a.pathToImages + "lens.png", 0, 0,
						16, 16), f.translate(7, e.height / 2 - 1), f.toFront(), b
						.push(f));
		d.toFront();
		b.push(d);
		f = b.getBBox();
		b.translate(a.marginLeftReal + a.plotAreaWidth - f.width,
				a.marginTopReal);
		b.hide();
	...
	drawPlotArea : function() {
		var a = this.dx, b = this.dy, d = this.marginLeftReal, e = this.marginTopReal, f = this.plotAreaWidth
				- 1, g = this.plotAreaHeight - 1, h = this.plotAreaFillColors, j = this.plotAreaFillAlphas, k = this.plotAreaBorderColor, l = this.plotAreaBorderAlpha;
		this.trendLinesSet.clipRect(d, e, f, g);
		"object" == typeof j && (j = j[0]);
		h = AmCharts.polygon(this.container, [0, f, f, 0], [0, 0, g, g], h, j,
				1, k, l, this.plotAreaGradientAngle);
		h.translate(d + a, e + b);
		this.set.push(h);
		0 !== a
				&& 0 !== b
				&& (h = this.plotAreaFillColors, "object" == typeof h
						&& (h = h[0]), h = AmCharts.adjustLuminosity(h, -0.15), f = AmCharts
						.polygon(this.container, [0, a, f + a, f, 0], [0, b, b,
										0, 0], h, j, 1, k, l), f.translate(d, e
								+ g), this.set.push(f), a = AmCharts.polygon(
						this.container, [0, 0, a, a, 0], [0, g, g + b, b, 0],
						h, j, 1, k, l), a.translate(d, e), this.set.push(a))
	},
	updatePlotArea : function() {
		var a = this.updateWidth(), b = this.updateHeight(), d = this.container;
		this.realWidth = a;
		this.realWidth = b;
	...
	updateDxy : function() {
		this.dx = Math.round(this.depth3D
				* Math.cos(this.angle * Math.PI / 180));
		this.dy = Math.round(-this.depth3D
	...
	updateChartCursor : function() {
		var a = this.chartCursor;
		a
				&& (a.x = this.marginLeftReal, a.y = this.marginTopReal, a.width = this.plotAreaWidth
	...
	addChartCursor : function(a) {
		...
		a
				&& (this.listenTo(a, "changed", this.handleCursorChange), this
						.listenTo(a, "zoomed", this.handleCursorZoom));
		this.chartCursor = a
	},
	...
	zoomTrendLines : function() {
		...
		for (b = 0; b < a.length; b++) {
			var d = a[b];
			d.valueAxis.recalculateToPercents
					? d.set && d.set.hide()
					: (d.x = this.marginLeftReal + this.horizontalPosition, d.y = this.marginTopReal
							+ this.verticalPosition, d.draw())
		}
	},
	...
	updateChartScrollbar : function(a, b) {
		if (a) {
			...
			"top" == a.position
					? b ? (a.y = d, a.x = e - f) : (a.y = d - f + h, a.x = e
							+ g)
					: b
							? (a.y = d + h, a.x = e + this.plotAreaWidth + g)
...
AmCharts.TrendLine = AmCharts.Class({
	...
	draw : function() {
		...
		j
				&& (k && (e = j.dateToCoordinate(k)), l
						&& (e = j.categoryToCoordinate(l)), m
						&& (f = j.dateToCoordinate(m)), n
						&& (f = j.categoryToCoordinate(n)));
		p
				&& !v
				&& (isNaN(r) || (e = p.getCoordinate(r)), isNaN(q)
						|| (f = p.getCoordinate(q)));
		s
				&& !v
				&& (isNaN(u) || (g = s.getCoordinate(u)), isNaN(t)
						|| (h = s.getCoordinate(t)));
		!isNaN(e)
				&& (!isNaN(f) && !isNaN(g) && !isNaN(g))
				&& (b.rotate ? (j = [g, h], f = [e, f]) : (j = [e, f], f = [g,
						h]), g = a.lineColor, e = AmCharts.line(d, j, f, g,
						a.lineAlpha, a.lineThickness, a.dashLength), f = AmCharts
						.line(d, j, f, g, 0.005, 5), d = d.set([e, f]), d
						.translate(b.marginLeftReal, b.marginTopReal), b.trendLinesSet
						.push(d), a.line = e, a.set = d, f.mouseup(function() {
							a.handleLineClick()
						}).mouseover(function() {
							a.handleLineOver()
						}).mouseout(function() {
...
AmCharts.AmSerialChart = AmCharts.Class({
		...
		if (AmCharts.ifArray(a)) {
			...
			if (0 < this.realWidth && 0 < this.realHeight) {
				...
				if (b.parseDates && !b.equalSpacing) {
					if (b = this.startTime, d = this.endTime, isNaN(b)
							|| isNaN(d))
	...
	cleanChart : function() {
		AmCharts.callMethod("destroy", [this.valueAxes, this.graphs,
						this.categoryAxis, this.chartScrollbar,
						this.chartCursor])
	},
	...
	updateData : function() {
		...
		for (b = 0; b < a.length; b++)
			a[b].data = d;
		0 < d.length
				&& (this.firstTime = this.getStartTime(d[0].time), this.lastTime = this
						.getEndTime(d[d.length - 1].time))
	},
	...
	getEndTime : function(a) {
		var b = this.categoryAxis;
		b.minDuration();
		return AmCharts.changeDate(new Date(a), b.minPeriod, 1, !0).getTime()
				- 1
	},
	updateMargins : function() {
		...
		a
				&& (this.getScrollbarPosition(a, this.rotate,
						this.categoryAxis.position), this.adjustMargins(a,
						this.rotate))
	},
	updateScrollbars : function() {
	...
	zoom : function(a, b) {
		...
		d.parseDates && !d.equalSpacing ? this.timeZoom(a, b) : this.indexZoom(
				a, b)
	},
	timeZoom : function(a, b) {
		var d = this.maxSelectedTime;
		isNaN(d)
				|| (b != this.endTime && b - a > d
						&& (a = b - d, this.updateScrollbar = !0), a != this.startTime
						&& b - a > d && (b = a + d, this.updateScrollbar = !0));
	...
	indexZoom : function(a, b) {
		...
		isNaN(d)
				|| (b != this.end && b - a > d
						&& (a = b - d, this.updateScrollbar = !0), a != this.start
						&& b - a > d && (b = a + d, this.updateScrollbar = !0));
		if (a != this.start || b != this.end) {
			...
			this.zoomAxesAndGraphs();
			this.zoomScrollbar();
			0 !== a || b != this.chartData.length - 1 ? this.showZB(!0) : this
					.showZB(!1);
			this.updateColumnsDepth();
	...
	zoomScrollbar : function() {
		...
		a
				...
				&& (b.parseDates && !b.equalSpacing ? a.timeZoom(
						this.startTime, this.endTime) : a.zoom(this.start,
						this.end), this.updateScrollbar = !0)
	},
	...
	zoomAxesAndGraphs : function() {
		if (!this.scrollbarOnly) {
			...
			this.zoomTrendLines();
			(b = this.chartCursor)
					&& b.zoom(this.start, this.end, this.startTime,
							this.endTime)
		}
	},
	countColumns : function() {
		...
		for (j = 0; j < b; j++) {
			...
			if ("100%" == k || "regular" == k) {
				g = !1;
				for (h = 0; h < d; h++)
					e = this.graphs[h], !e.hidden
							&& (e.valueAxis == f && "column" == e.type)
							&& (!g && e.stackable && (a++, g = !0), e.stackable
									|| a++, e.columnIndex = a - 1)
			}
			if ("none" == k || "3d" == k)
				for (h = 0; h < d; h++)
			...
			if ("3d" == k) {
				for (j = 0; j < d; j++)
					e = this.graphs[j], e.depthCount = a;
				a = 1
			}
		}
		return a
	...
	dispatchTimeZoomEvent : function() {
		if (this.prevStartTime != this.startTime
	...
	updateLegendValues : function(a) {
		...
		for (d = 0; d < b.length; d++) {
			var e = b[d];
			e.currentDataItem = isNaN(a)
					? void 0
					: this.chartData[a].axes[e.valueAxis.id].graphs[e.id]
		}
	...
	getClosestIndex : function(a, b, d, e, f, g) {
		...
		return d == j ? h : d < j
				? this.getClosestIndex(a, b, d, e, f, h)
				: this.getClosestIndex(a, b, d, e, h, g)
	},
	zoomToIndexes : function(a, b) {
		...
		if (d) {
			var e = d.length;
			0 < e
					&& (0 > a && (a = 0), b > e - 1 && (b = e - 1), e = this.categoryAxis, e.parseDates
							&& !e.equalSpacing ? this.zoom(d[a].time, this
									.getEndTime(d[b].time)) : this.zoom(a, b))
		}
	},
	zoomToDates : function(a, b) {
		...
		if (this.categoryAxis.equalSpacing) {
			var e = this.getClosestIndex(d, "time", a.getTime(), !0, 0,
					d.length), d = this.getClosestIndex(d, "time", b.getTime(),
					!1, 0, d.length);
			this.zoom(e, d)
		} else
	...
	zoomToCategoryValues : function(a, b) {
		this.updateScrollbar = !0;
		this.zoom(this.getCategoryIndexByValue(a), this
						.getCategoryIndexByValue(b))
	},
	formatString : function(a, b) {
		var d = b.graph;
		if (-1 != a.indexOf("[[category]]")) {
			...
			if (this.categoryAxis.parseDates) {
				...
				-1 != a.indexOf("[[category]]")
						&& (f = AmCharts.formatDate(e, f), -1 != f
								.indexOf("fff")
								&& (f = AmCharts.formatMilliseconds(f, e)), e = f)
			}
		...
		if ((f = e.duration) && !isNaN(b.values.value))
			e = AmCharts.formatDuration(b.values.value, f, "", e.durationUnits,
					e.maxInterval, d), a = a.replace(RegExp(
							"\\[\\[value\\]\\]", "g"), e);
		e = "value open low high close total".split(" ");
		f = this.percentFormatter;
		a = AmCharts.formatValue(a, b.percents, e, f, "percents\\.");
		a = AmCharts.formatValue(a, b.values, e, d, "", this.usePrefixes,
	...
	addChartScrollbar : function(a) {
		...
		a
				&& (a.chart = this, this.listenTo(a, "zoomed",
...
AmCharts.AmRadarChart = AmCharts.Class({
	...
	drawChart : function() {
		...
		var a = this.updateWidth(), b = this.updateHeight(), d = this.marginTop
				+ this.getTitleHeight(), e = this.marginLeft, b = b - d
				- this.marginBottom;
	...
	formatString : function(a, b) {
		...
		-1 != a.indexOf("[[category]]")
				&& (a = a.replace(/\[\[category\]\]/g,
						String(b.serialDataItem.category)));
		d = d.numberFormatter;
		d || (d = this.numberFormatter);
		a = AmCharts.formatValue(a, b.values, ["value"], d, "",
				this.usePrefixes, this.prefixesOfSmallNumbers,
				this.prefixesOfBigNumbers);
...
AmCharts.AxisBase = AmCharts.Class({
	...
	fixAxisPosition : function() {
		var a = this.position;
		"H" == this.orientation ? ("left" == a && (a = "bottom"), "right" == a
				&& (a = "top")) : ("bottom" == a && (a = "left"), "top" == a
				&& (a = "right"));
		this.position = a
	},
	draw : function() {
		...
		this.autoGridCount
				&& ("V" == this.orientation ? (a = this.height / 35, 3 > a
						&& (a = 3)) : a = this.width / this.minGap, this.gridCount = Math
						.max(a, 1));
	...
	addTitle : function() {
		...
		if (a) {
			var b = this.chart;
			this.titleLabel = AmCharts.text(b.container, a, this.titleColor,
					b.fontFamily, this.titleFontSize, "middle", this.titleBold)
		}
	},
	positionTitle : function() {
		...
		if (a) {
			...
			0 < e.length()
					? f = e.getBBox()
					: (f.x = 0, f.y = 0, f.width = this.viW, f.height = this.viH);
			e.push(a);
			var e = f.x, g = f.y;
			...
			this.marginsChanged
					? (a.translate(b, d), this.tx = b, this.ty = d)
	...
	handleGuideOver : function(a) {
		...
		var b = a.graphics.getBBox(), d = b.x + b.width / 2, b = b.y + b.height
				/ 2, e = a.fillColor;
...
AmCharts.ValueAxis = AmCharts.Class({
	...
	updateData : function() {
		...
		"xy" != this.chart.chartType
				&& (this.stackGraphs("smoothedLine"), this.stackGraphs("line"), this
						.stackGraphs("column"), this.stackGraphs("step"));
	...
	draw : function() {
		...
		if (this.logarithmic
			...
			if (!isNaN(this.min) && !isNaN(this.max) && this.foundGraphs
				...
				var l = this.labelFrequency, m = this.showFirstLabel, n = this.showLastLabel, s = 1, p = 0, r = Math
						.round((this.max - this.min) / this.step)
						+ 1, q;
				!0 === j
						? (q = Math.log(this.max) * Math.LOG10E
								- Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth
								/ q, 2 < q
								&& (r = Math.ceil(Math.log(this.max)
										* Math.LOG10E)
										+ 1, p = Math.round(Math
										.log(this.minReal)
										* Math.LOG10E), r > this.gridCount
										&& (s = Math.ceil(r / this.gridCount))))
						: this.stepWidth = this.axisWidth
								/ (this.max - this.min);
				d = 0;
				1 > this.step && -1 < this.step
						&& (d = this.getDecimals(this.step));
				...
				if (0 < w) {
					...
					for (e = this.fillAlpha = 0; e < w; e++) {
						...
						isNaN(x.toValue)
								|| (z = this.getCoordinate(x.toValue), t = new this.axisItemRenderer(
										this, z, "", !0, NaN, NaN, x), this
										.pushAxisItem(t, C));
						var I = NaN;
						isNaN(x.value)
								|| (I = this.getCoordinate(x.value), t = new this.axisItemRenderer(
										this, I, x.label, !0, NaN, (z - I) / 2,
										x), this.pushAxisItem(t, C));
						isNaN(z - I)
								|| (t = new this.guideFillRenderer(this, I, z,
										x), this.pushAxisItem(t, C), t = t
										.graphics(), x.graphics = t, x.balloonText
										&& this.addEventListeners(t, x))
					}
					this.fillAlpha = y
				}
				v = !1;
				for (e = p; e < r; e += s)
					t = AmCharts.roundTo(this.step * e + this.min, d), -1 != String(t)
							.indexOf("e")
							&& (v = !0, String(t).split("e"));
				this.duration
						&& (this.maxInterval = AmCharts.getMaxInterval(
								this.max, this.duration));
				for (e = p; e < r; e += s)
					if (p = this.step * e + this.min, p = AmCharts.roundTo(p,
							this.maxDecCount + 1), !(this.integersOnly && Math
							.round(p) != p)) {
						!0 === j
								&& (0 === p && (p = this.minReal), 2 < q
										&& (p = Math.pow(10, e)), v = -1 != String(p)
										.indexOf("e") ? !0 : !1);
						this.useScientificNotation && (v = !0);
						this.usePrefixes && (v = !1);
						v
								? (t = -1 == String(p).indexOf("e") ? p
										.toExponential(15) : String(p), t = t
										.split("e"), d = Number(t[0]), t = Number(t[1]), d = AmCharts
										.roundTo(d, 14), 10 == d
										&& (d = 1, t += 1), t = d + "e" + t, 0 === p
										&& (t = "0"), 1 == p && (t = "1"))
								: (j
										&& (d = String(p).split("."), u.precision = d[1]
												? d[1].length
												: -1), t = this.usePrefixes
										? AmCharts.addPrefix(p,
												a.prefixesOfBigNumbers,
												a.prefixesOfSmallNumbers, u)
										: AmCharts.formatNumber(p, u,
												u.precision));
						this.duration
								&& (t = AmCharts.formatDuration(p,
										this.duration, "", this.durationUnits,
										this.maxInterval, u));
						this.recalculateToPercents ? t += "%" : (d = this.unit)
								&& (t = "left" == this.unitPosition ? d + t : t
										+ d);
							...
							"H" == this.orientation
									...
									: 0 <= d
											...
											&& (G = [0, w, w + f], O = [d, d,
													d + g]);
							G
									&& (d = AmCharts.fitToBounds(2
													* this.gridAlpha, 0, 1), d = AmCharts
											.line(a.container, G, O,
													this.gridColor, d, 1,
													this.dashLength), d
											.translate(p, t), this.grid0 = d, a.axesSet
											.push(d), d.toBack())
						}
					}
				e = this.baseValue;
			...
			a = this.labelsSet;
			this.positionTitle();
			"radar" != k ? (k = this.viX, e = this.viY, b.translate(k, e), a
					.translate(k, e)) : j.toFront();
			!this.visible || h ? (b.hide(), j.hide(), a.hide()) : (b.show(), j
					.show(), a.show())
		}
	},
	getDecimals : function(a) {
		var b = 0;
		isNaN(a)
				|| (a = String(a), -1 != a.indexOf("e-") ? b = Number(a
						.split("-")[1]) : -1 != a.indexOf(".")
						&& (b = a.split(".")[1].length));
		return b
	},
	stackGraphs : function(a) {
		...
		if (p && ("regular" == b || "100%" == b))
			for (n = 0; n < j.length; n++)
				m = j[n], m.hidden
						|| (l = m.type, m.chart == this.chart
								&& (m.valueAxis == this && a == l && m.stackable)
		...
		for (k = this.start; k <= this.end; k++) {
			...
			for (n = 0; n < j.length; n++)
				if (m = j[n], !m.hidden
						&& (l = m.type, m.chart == this.chart
								&& (m.valueAxis == this && a == l && m.stackable)
								&& (l = this.data[k].axes[this.id].graphs[m.id], h = l.values.value, !isNaN(h)))) {
					...
					"regular" == b
							&& (p
									&& (isNaN(d[k])
											? (d[k] = h, l.values.close = h, l.values.open = this.baseValue)
											: (l.values.close = isNaN(h)
													? d[k]
													: h + d[k], l.values.open = d[k], d[k] = l.values.close)), "column" == a
									&& !isNaN(h)
									&& (l.values.close = h, 0 > h
											? (l.values.close = h, isNaN(e[k])
													? l.values.open = s
													: (l.values.close += e[k], l.values.open = e[k]), e[k] = l.values.close)
											: (l.values.close = h, isNaN(f[k])
													? l.values.open = s
													: (l.values.close += f[k], l.values.open = f[k]), f[k] = l.values.close)))
				}
		}
		for (k = this.start; k <= this.end; k++)
			for (n = 0; n < j.length; n++)
				m = j[n], m.hidden
						|| (l = m.type, m.chart == this.chart
								&& (m.valueAxis == this && a == l && m.stackable)
								&& (l = this.data[k].axes[this.id].graphs[m.id], h = l.values.value, isNaN(h)
										|| (d = 100 * (h / g[k]), l.values.percents = d, l.values.total = g[k], "100%" == b
												&& (isNaN(e[k]) && (e[k] = 0), isNaN(f[k])
														&& (f[k] = 0), 0 > d
														? (l.values.close = AmCharts
																.fitToBounds(
																		d
																				+ e[k],
																		-100,
																		100), l.values.open = e[k], e[k] = l.values.close)
														: (l.values.close = AmCharts
																.fitToBounds(
																		d
																				+ f[k],
																		-100,
																		100), l.values.open = f[k], f[k] = l.values.close)))))
	},
		...
		for (b = 0; b < a.length; b++) {
			...
			if (d.valueAxis == this) {
				...
				if ("candlestick" == d.type || "ohlc" == d.type)
					e = "open";
				var f, g, h = this.end + 2, h = AmCharts.fitToBounds(this.end
								+ 1, 0, this.data.length - 1), j = this.start;
				0 < j && j--;
				var k;
				for (k = this.start; k <= h
				...
				for (e = j; e <= h; e++) {
					...
					var j = g.values, l;
					for (l in j)
						g.percents[l] = "percents" != l ? 100 * (j[l] / f)
								- 100 : j[l]
				}
			}
		}
	...
	getMinMax : function() {
		...
		a
				&& (0 < this.start && this.start--, this.end < this.data.length
						- 1
						&& this.end++);
		...
		if (this.includeGuidesInMinMax && 0 < a)
			for (b = 0; b < a; b++)
				d = this.guides[b], d.toValue < this.min
						&& (this.min = d.toValue), d.value < this.min
						&& (this.min = d.value), d.toValue > this.max
						&& (this.max = d.toValue), d.value > this.max
						&& (this.max = d.value);
		...
		b = this.max;
		d = this.max - this.min;
		e = 0 === d ? Math.pow(10, Math.floor(Math.log(Math.abs(this.max))
						* Math.LOG10E))
				/ 10 : Math.pow(10, Math.floor(Math.log(Math.abs(d))
						* Math.LOG10E))
				/ 10;
		...
		"100%" == this.stackType
				&& (this.min = 0 > this.min ? -100 : 0, this.max = 0 > this.max
						? 0
						: 100);
		d = this.max - this.min;
		...
		d = Math.pow(10, Math
						.floor(Math.log(Math.abs(this.step)) * Math.LOG10E));
		...
		1 > d
				? (this.maxDecCount = Math.abs(Math.log(Math.abs(d))
						* Math.LOG10E), this.maxDecCount = Math
						.round(this.maxDecCount), this.step = AmCharts.roundTo(
						this.step, this.maxDecCount + 1))
				: this.maxDecCount = 0;
		...
		d = Math.pow(10, Math.floor(Math.log(Math.abs(this.minReal))
						* Math.LOG10E));
		...
		this.logarithmic
				&& (2 < d
						? (this.minReal = this.min = Math.pow(10, Math
										.floor(Math.log(Math.abs(a))
												* Math.LOG10E)), this.max = Math
								.pow(10, Math.ceil(Math.log(Math.abs(b))
												* Math.LOG10E)))
						: (b = Math.pow(10, Math.floor(Math.log(Math
										.abs(this.min))
										* Math.LOG10E))
								/ 10, a = Math.pow(10, Math.floor(Math.log(Math
										.abs(a))
										* Math.LOG10E))
								/ 10, b < a
								&& (this.minReal = this.min = 10 * a)))
	},
	...
	zoomToValues : function(a, b) {
		...
		d.chart = this.chart;
		d.valueAxis = this;
		d.multiplier = this.axisWidth
				/ Math.abs(this.getCoordinate(b) - this.getCoordinate(a));
		d.position = "V" == this.orientation ? this.reversed ? this
				.getCoordinate(a) : this.getCoordinate(b) : this.reversed
	...
	coordinateToValue : function(a) {
		...
		return !0 === this.logarithmic ? Math.pow(10, (f ? !0 === e ? (b - a)
						/ d : a / d : !0 === e ? a / d : (b - a) / d)
						+ Math.log(h) * Math.LOG10E) : !0 === e ? f ? g
				- (a - b) / d : a / d + g : f ? a / d + g : g - (a - b) / d
	},
	getCoordinate : function(a) {
		if (isNaN(a))
			return NaN;
		var b = this.rotate, d = this.reversed, e = this.axisWidth, f = this.stepWidth, g = this.min, h = this.minReal;
		!0 === this.logarithmic ? (a = Math.log(a) * Math.LOG10E - Math.log(h)
				* Math.LOG10E, b = b ? !0 === d ? e - f * a : f * a : !0 === d
				? f * a
				: e - f * a) : b = !0 === d
				? b ? e - f * (a - g) : f * (a - g)
				: b ? f * (a - g) : e - f * (a - g);
	...
	synchronizeWithAxis : function(a) {
		...
		this.removeListener(this.synchronizeWithAxis, "axisChanged",
				this.handleSynchronization);
		this.listenTo(this.synchronizeWithAxis, "axisChanged",
				this.handleSynchronization)
	},
	handleSynchronization : function() {
		var a = this.synchronizeWithAxis, b = a.min, d = a.max, a = a.step, e = this.synchronizationMultiplier;
		e
				&& (this.min = b * e, this.max = d * e, this.step = a * e, b = Math
						.pow(10, Math.floor(Math.log(Math.abs(this.step))
										* Math.LOG10E)), b = Math.abs(Math
						.log(Math.abs(b))
						* Math.LOG10E), this.maxDecCount = b = Math.round(b), this
						.draw())
	}
});
AmCharts.CategoryAxis = AmCharts.Class({
	...
	draw : function() {
		...
		if (AmCharts.ifArray(a)) {
			...
			b = this.end - e + 1;
			var h = this.gridCount, j = this.showFirstLabel, k = this.showLastLabel, l, m = "", m = AmCharts
					.extractPeriod(this.minPeriod);
			l = AmCharts.getPeriodDuration(m.period, m.count);
			var n, s, p, r, q;
			n = this.rotate;
			var u = this.firstDayOfWeek, t = this.boldPeriodBeginning, a = AmCharts
					.resetDateToMin(new Date(a[a.length - 1].time + 1.05 * l),
							this.minPeriod, 1, u).getTime(), v;
			this.endTime > a && (this.endTime = a);
			if (this.parseDates && !this.equalSpacing) {
				if (this.timeDifference = this.endTime - this.startTime, e = this
						.choosePeriod(0), f = e.period, n = e.count, a = AmCharts
						.getPeriodDuration(f, n), a < l
						&& (f = m.period, n = m.count, a = l), s = f, "WW" == s
						&& (s = "DD"), this.stepWidth = this
						.getStepWidth(this.timeDifference), h = Math
						.ceil(this.timeDifference / a)
						+ 1, m = AmCharts.resetDateToMin(
						new Date(this.startTime - a), f, n, u).getTime(), s == f
						&& 1 == n && (p = a * this.stepWidth), this.cellWidth = l
						* this.stepWidth, b = Math.round(m / a), e = -1, b / 2 == Math
						.round(b / 2)
						&& (e = -2, m -= a), 0 < this.gridCount)
					for (b = e; b <= h; b++) {
						r = m + 1.5 * a;
						r = AmCharts.resetDateToMin(new Date(r), f, n, u)
								.getTime();
						l = (r - this.startTime) * this.stepWidth;
						q = !1;
						this.nextPeriod[s]
								&& (q = this.checkPeriodChange(
										this.nextPeriod[s], 1, r, m));
						v = !1;
						q
								? (m = this.dateFormatsObject[this.nextPeriod[s]], v = !0)
								: m = this.dateFormatsObject[s];
						t || (v = !1);
						m = AmCharts.formatDate(new Date(r), m);
						if (b == e && !j || b == h && !k)
							m = " ";
						l = new this.axisItemRenderer(this, l, m, !1, p, 0, !1,
								v);
						this.pushAxisItem(l);
						m = r
					}
				...
				if (this.parseDates && this.equalSpacing) {
					...
					m = AmCharts.resetDateToMin(new Date(this.startTime - a),
							f, n, u).getTime();
					...
					for (this.end - this.start > this.gridCount && (u = !0); b < p; b++)
						if (r = this.data[b].time, this.checkPeriodChange(f, n,
								r, m)) {
							...
							u
									? u = !1
									: (t || (v = !1), l = new this.axisItemRenderer(
											this, l, m, void 0, void 0, void 0,
											void 0, v), l.graphics(), this
											.pushAxisItem(l));
							m = r
						}
				}
			} else if (this.cellWidth = this.getStepWidth(b), b < h && (h = b), g += this.start, this.stepWidth = this
					.getStepWidth(b), 0 < h) {
				t = Math.floor(b / h);
				b = g;
				b / 2 == Math.round(b / 2) && b--;
				...
				for (h = 0; b <= this.end + 2; b++)
					if (0 <= b && b < this.data.length
							? (s = this.data[b], m = s.category)
							: m = "", b / t == Math.round(b / t) || s.forceShow) {
						l = this.getCoordinate(b - g);
						p = 0;
						"start" == this.gridPosition
								&& (l -= this.cellWidth / 2, p = this.cellWidth
										/ 2);
			...
			for (b = 0; b < this.data.length; b++)
				if (j = this.data[b])
					k = this.parseDates && !this.equalSpacing ? Math
							.round((j.time - this.startTime) * this.stepWidth
									+ this.cellWidth / 2) : this
							.getCoordinate(b - g), j.x[this.id] = k;
			j = this.guides.length;
			for (b = 0; b < j; b++)
				k = this.guides[b], p = p = p = h = t = NaN, e = k.above, k.toCategory
						&& (p = d.getCategoryIndexByValue(k.toCategory), isNaN(p)
								|| (t = this.getCoordinate(p - g), l = new this.axisItemRenderer(
										this, t, "", !0, NaN, NaN, k), this
										.pushAxisItem(l, e))), k.category
						&& (p = d.getCategoryIndexByValue(k.category), isNaN(p)
								|| (h = this.getCoordinate(p - g), p = (t - h)
										/ 2, l = new this.axisItemRenderer(
										this, h, k.label, !0, NaN, p, k), this
										.pushAxisItem(l, e))), k.toDate
						&& (this.equalSpacing
								? (p = d.getClosestIndex(this.data, "time",
										k.toDate.getTime(), !1, 0,
										this.data.length - 1), isNaN(p)
										|| (t = this.getCoordinate(p - g)))
								: t = (k.toDate.getTime() - this.startTime)
										* this.stepWidth, l = new this.axisItemRenderer(
								this, t, "", !0, NaN, NaN, k), this
								.pushAxisItem(l, e)), k.date
						&& (this.equalSpacing
								? (p = d.getClosestIndex(this.data, "time",
										k.date.getTime(), !1, 0,
										this.data.length - 1), isNaN(p)
										|| (h = this.getCoordinate(p - g)))
								: h = (k.date.getTime() - this.startTime)
										* this.stepWidth, p = (t - h) / 2, l = "H" == this.orientation
								? new this.axisItemRenderer(this, h, k.label,
										!1, 2 * p, NaN, k)
								: new this.axisItemRenderer(this, h, k.label,
										!1, NaN, p, k), this.pushAxisItem(l, e)), t = new this.guideFillRenderer(
						this, h, t, k), h = t.graphics(), this.pushAxisItem(t,
						e), k.graphics = h, h.index = b, k.balloonText
						&& this.addEventListeners(h, k)
		}
		this.axisCreated = !0;
		d = this.x;
		g = this.y;
	...
	choosePeriod : function(a) {
		var b = AmCharts.getPeriodDuration(this.periods[a].period,
				this.periods[a].count), d = Math.ceil(this.timeDifference / b), e = this.periods;
		return this.timeDifference < b && 0 < a
				? e[a - 1]
				: d <= this.gridCount ? e[a] : a + 1 < e.length ? this
						.choosePeriod(a + 1) : e[a]
	},
	getStepWidth : function(a) {
		var b;
		this.startOnAxis ? (b = this.axisWidth / (a - 1), 1 == a
				&& (b = this.axisWidth)) : b = this.axisWidth / a;
		return b
	},
	getCoordinate : function(a) {
		a *= this.stepWidth;
	...
	xToIndex : function(a) {
		...
		this.parseDates && !this.equalSpacing
				? (a = this.startTime + Math.round(a / f) - this.minDuration()
						/ 2, d = d.getClosestIndex(b, "time", a, !1,
						this.start, this.end + 1))
				: (this.startOnAxis || (a -= f / 2), d = this.start
						+ Math.round(a / f));
	...
	dateToCoordinate : function(a) {
		return this.parseDates && !this.equalSpacing
				...
				: this.parseDates && this.equalSpacing ? (a = this.chart
						.getClosestIndex(this.data, "time", a.getTime(), !1, 0,
								this.data.length - 1), this.getCoordinate(a
						- this.start)) : NaN
	},
	categoryToCoordinate : function(a) {
		return this.chart ? (a = this.chart.getCategoryIndexByValue(a), this
				.getCoordinate(a - this.start)) : NaN
	},
...
AmCharts.RecAxis = AmCharts.Class({
	construct : function(a) {
		...
		"H" == a.orientation
				? (e = AmCharts.line(s, [0, n], [0, 0], e, f, d), this.axisWidth = a.width, "bottom" == a.position
						? (a = d / 2 + g + m + l - 1, d = k)
						: (a = -d / 2 - g + l + j, d = h + k))
				: (this.axisWidth = a.height, "right" == a.position
						? (e = AmCharts.line(s, [0, 0, -h], [0, m, m - j], e,
								f, d), a = l + j, d = d / 2 + g + h + n + k - 1)
						: (e = AmCharts.line(s, [0, 0], [0, m], e, f, d), a = l, d = -d
								/ 2 - g + k));
		e.translate(d, a);
		b.axesSet.push(e);
		this.set = e
...
AmCharts.RecItem = AmCharts.Class({
	construct : function(a, b, d, e, f, g, h, j, k) {
		...
		this.set = p;
		var r = a.axisThickness, q = a.axisColor, u = a.axisAlpha, t = a.tickLength, v = a.gridAlpha, w = a.gridThickness, y = a.gridColor, x = a.dashLength, z = a.fillColor, C = a.fillAlpha, I = a.labelsEnabled, G = a.labelRotation, O = a.counter, R = a.inside, U = a.dx, T = a.dy, ea = a.orientation, N = a.position, V = a.previousCoord, fa = a.viH, ca = a.viW, da = a.offset, ma, W;
		h
				? (I = !0, isNaN(h.tickLength) || (t = h.tickLength), void 0 != h.lineColor
						&& (y = h.lineColor), isNaN(h.lineAlpha)
						|| (v = h.lineAlpha), isNaN(h.dashLength)
						|| (x = h.dashLength), isNaN(h.lineThickness)
						|| (w = h.lineThickness), !0 === h.inside && (R = !0), isNaN(h.labelRotation)
						|| (G = h.labelRotation))
				: "" === d && (t = 0);
		W = "start";
		f && (W = "middle");
		...
		if ("H" == ea) {
			if (0 <= b
					...
					&& (0 < t
							&& (0 < u && b + k <= ca + 1)
							&& (ma = AmCharts.line(s, [b + k, b + k], [0, t],
									q, u, w), p.push(ma)), 0 < v
							&& (W = AmCharts.line(s, [b, b + U, b + U], [fa,
											fa + T, T], y, v, w, x), p.push(W))), E = 0, F = b, h
					&& 90 == G && (F -= m), !1 === e
					? (W = "start", E = "bottom" == N ? R ? E + t : E - t : R
							? E - t
							: E + t, F += 3, f && (F += f / 2, W = "middle"), 0 < G
							&& (W = "middle"))
					: W = "middle", 1 == O
					&& (0 < C && !h && V < ca)
					&& (e = AmCharts.fitToBounds(b, 0, ca), V = AmCharts
							.fitToBounds(V, 0, ca), aa = e - V, 0 < aa
							&& (fill = AmCharts.rect(s, aa, a.height, z, C), fill
									.translate(e - aa + U, T), p.push(fill))), "bottom" == N
					? (E += fa + m / 2 + da, R ? 0 < G
							? (E = fa - ga / 2 * Math.sin(P) - t - 3, F += ga
									/ 2 * Math.cos(P))
							: E -= t + m + 3 + 3 : 0 < G
							? (E = fa + ga / 2 * Math.sin(P) + t + 3, F -= ga
									/ 2 * Math.cos(P))
							: E += t + r + 3 + 3)
					: (E += T + m / 2 - da, F += U, R ? 0 < G
							? (E = ga / 2 * Math.sin(P) + t + 3, F -= ga / 2
									* Math.cos(P))
							: E += t + 3 : 0 < G ? (E = -(ga / 2) * Math.sin(P)
							- t - 6, F += ga / 2 * Math.cos(P)) : E -= t + m
							+ 3 + r + 3), "bottom" == N ? aa = (R
					? fa - t - 1
					: fa + r - 1)
					+ da : (A = U, aa = (R ? T : T - t - r + 1) - da), g
					&& (F += g), T = F, 0 < G && (T += ga / 2 * Math.cos(P)), X
					&& (N = 0, R && (N = ga / 2 * Math.cos(P)), T + N > ca + 1
							|| 0 > T))
				X.remove(), X = null
		} else {
			0 <= b
					...
					&& (0 < t
							&& (0 < u && b + k <= fa + 1)
							&& (ma = AmCharts.line(s, [0, t], [b + k, b + k],
									q, u, w), p.push(ma)), 0 < v
							&& (W = AmCharts.line(s, [0, U, ca + U], [b, b + T,
											b + T], y, v, w, x), p.push(W)));
			W = "end";
			if (!0 === R && "left" == N || !1 === R && "right" == N)
				W = "start";
			E = b - m / 2;
			1 == O
					&& (0 < C && !h)
					&& (e = AmCharts.fitToBounds(b, 0, fa), V = AmCharts
							.fitToBounds(V, 0, fa), P = e - V, fill = AmCharts
							.polygon(s, [0, a.width, a.width, 0], [0, 0, P, P],
									z, C), fill.translate(U, e - P + T), p
							.push(fill));
			E += m / 2;
			"right" == N ? (F += U + ca + da, E += T, R ? (F -= t + 4, g
					|| (E -= m / 2 + 3)) : (F += t + 4 + r, E -= 2)) : R
					? (F += t + 4 - da, g || (E -= m / 2 + 3), h
							&& (F += U, E += T))
					: (F += -t - r - 4 - 2 - da, E -= 2);
			ma
					&& ("right" == N ? (A += U + da + ca, aa += T, A = R ? A
							- r : A + r) : (A -= da, R || (A -= t + r)));
			g && (E += g);
			R = -3;
			"right" == N && (R += T);
		...
		X
				&& (X.attr({
							"text-anchor" : W
						}), X.translate(F, E), 0 !== G && X.rotate(-G), a.allLabels
						.push(X), " " != d && (this.label = X));
		a.counter = 0 === O ? 1 : 0;
		a.previousCoord = b;
...
AmCharts.RecFill = AmCharts.Class({
	construct : function(a, b, d, e) {
		...
		k = a.chart.container;
		e = e.fillColor;
		"V" == h ? (b = AmCharts.fitToBounds(b, 0, a.viH), d = AmCharts
				.fitToBounds(d, 0, a.viH)) : (b = AmCharts.fitToBounds(b, 0,
				a.viW), d = AmCharts.fitToBounds(d, 0, a.viW));
		d -= b;
		isNaN(d) && (d = 4, j = 2, l = 0);
		0 > d && "object" == typeof e && (e = e.join(",").split(",").reverse());
		"V" == h ? (a = AmCharts.rect(k, a.width, d, e, l), a.translate(f, b
						- j + g)) : (a = AmCharts.rect(k, d, a.height, e, l), a
				.translate(b - j + f, g));
		this.set = k.set([a])
	},
	graphics : function() {
...
AmCharts.RadAxis = AmCharts.Class({
	construct : function(a) {
		...
		if (b) {
			...
			var s = a.length, p;
			for (p = 0; p < s; p++) {
				var r = 180 - 360 / s * p, q = g + this.axisWidth
						* Math.sin(r / 180 * Math.PI), u = h + this.axisWidth
						* Math.cos(r / 180 * Math.PI);
				0 < f
						&& (q = AmCharts.line(b.container, [g, q], [h, u], e,
								f, d), this.set.push(q));
				if (k) {
					var t = "start", q = g + (this.axisWidth + j)
							* Math.sin(r / 180 * Math.PI), u = h
							+ (this.axisWidth + j)
							* Math.cos(r / 180 * Math.PI);
					if (180 == r || 0 === r)
						t = "middle", q -= 5;
...
AmCharts.RadItem = AmCharts.Class({
	construct : function(a, b, d, e, f, g, h) {
		...
		var G = a.y;
		h
				? (y = !0, isNaN(h.tickLength) || (p = h.tickLength), void 0 != h.lineColor
						&& (u = h.lineColor), isNaN(h.lineAlpha)
						|| (r = h.lineAlpha), isNaN(h.dashLength)
						|| (t = h.dashLength), isNaN(h.lineThickness)
						|| (q = h.lineThickness), !0 === h.inside && (x = !0))
				: d || (r /= 3, p /= 2);
		var O = "end", R = -1;
		x && (O = "start", R = 1);
		var U;
		y
				&& (U = AmCharts.text(m, d, l, j, k, O), U.translate(g
								+ (p + 3) * R, b), e.push(U), this.label = U, I = AmCharts
						.line(m, [g, g + p * R], [b, b], n, s, q), e.push(I));
		b = a.y - b;
		d = [];
		j = [];
		if (0 < r) {
			if ("polygons" == z) {
				C = a.data.length;
				for (k = 0; k < C; k++)
					l = 180 - 360 / C * k, d.push(b
							* Math.sin(l / 180 * Math.PI)), j.push(b
							* Math.cos(l / 180 * Math.PI));
				d.push(d[0]);
				j.push(j[0]);
				r = AmCharts.line(m, d, j, u, r, q, t)
			} else
				r = AmCharts.circle(m, b, "#FFFFFF", 0, q, u, r);
			r.translate(g, G);
			e.push(r)
		}
		if (1 == f && 0 < w && !h) {
			...
			if ("polygons" == z) {
				for (k = C; 0 <= k; k--)
					l = 180 - 360 / C * k, d.push(h
							* Math.sin(l / 180 * Math.PI)), j.push(h
							* Math.cos(l / 180 * Math.PI));
...
AmCharts.RadarFill = AmCharts.Class({
	construct : function(a, b, d, e) {
		...
		if ("polygons" == a.gridType) {
			...
			for (m = 0; m < l; m++)
				j = 180 - 360 / l * m, e.push(f * Math.sin(j / 180 * Math.PI)), k
						.push(f * Math.cos(j / 180 * Math.PI));
			e.push(e[0]);
			k.push(k[0]);
			for (m = l; 0 <= m; m--)
				j = 180 - 360 / l * m, e.push(b * Math.sin(j / 180 * Math.PI)), k
						.push(b * Math.cos(j / 180 * Math.PI));
...
AmCharts.AmGraph = AmCharts.Class({
	...
	draw : function() {
		...
		this.destroy();
		var d = b.set(), e = b.set();
		this.behindColumns ? (a.graphsBehindSet.push(d), a.bulletBehindSet
				.push(e)) : (a.graphsSet.push(d), a.bulletSet.push(e));
		this.bulletSet = e;
		if (!this.scrollbar) {
		...
		AmCharts.ifArray(this.data)
				&& (d = !1, "xy" == this.chartType
						? this.xAxis.axisCreated && this.yAxis.axisCreated
								&& (d = !0)
						: this.valueAxis.axisCreated && (d = !0), !this.hidden
						&& d && this.createGraph())
	},
	createGraph : function() {
		...
		void 0 === this.bulletColor
				&& (this.bulletColor = this.lineColor, this.bulletColorNegative = this.negativeLineColor);
		...
		if (!isNaN(this.valueAxis.min) && !isNaN(this.valueAxis.max)) {
			switch (this.chartType) {
				case "serial" :
					...
					"candlestick" == this.type
							&& 1 > this.valueAxis.minMaxMultiplier
	...
	createXYGraph : function() {
		...
		for (f = this.start; f <= this.end; f++) {
			var g = this.data[f].axes[d.id].graphs[this.id], h = g.values, j = h.x, k = h.y, h = d
					.getCoordinate(j), l = e.getCoordinate(k);
			if (!isNaN(j)
					&& !isNaN(k)
					&& (a.push(h), b.push(l), (j = this
							.createBullet(g, h, l, f))
							|| (j = 0), k = this.labelText))
				g = this.createLabel(g, h, l, k), this.allBullets.push(g), this
						.positionLabel(h, l, g, this.labelPosition, j)
		}
	...
	createRadarGraph : function() {
		...
		for (g = this.start; g <= this.end; g++) {
			...
			if (isNaN(j))
				this.drawLineGraph(b, d), b = [], d = [];
			else {
				var k = this.y
						- (this.valueAxis.getCoordinate(j) - this.height), l = 180
						- 360 / (this.end - this.start + 1) * g;
				...
				m
						&& (h = this.createLabel(h, j, k, m), this.allBullets
								.push(h), this.positionLabel(j, k, h,
								this.labelPosition, l));
				isNaN(e) && (e = j);
				isNaN(f) && (f = k)
			}
		}
	...
	createSerialGraph : function() {
		var a = this.id, b = this.index, d = this.data, e = this.chart.container, f = this.valueAxis, g = this.type, h = this.columnWidth, j = this.width, k = this.height, l = this.y, m = this.rotate, n = this.columnCount, s = AmCharts
				.toCoordinate(this.cornerRadiusTop, h / 2), p = this.connect, r = [], q = [], u, t, v = this.chart.graphs.length, w, y = this.dx
				/ this.depthCount, x = this.dy / this.depthCount, z = f.stackType, C = this.labelPosition, I = this.start, G = this.end, O = this.scrollbar, R = this.categoryAxis, U = this.baseCoord, T = this.negativeBase, ea = this.columnIndex, N = this.lineThickness, V = this.lineAlpha, fa = this.lineColor, ca = this.dashLength, da = this.set;
		"above" == C && (C = "top");
		"below" == C && (C = "bottom");
		var ma = C, W = 270;
		"horizontal" == this.gradientOrientation && (W = 0);
		this.gradientRotation = W;
		var P = this.chart.columnSpacing, aa = R.cellWidth, F = (aa * h - n)
				/ n;
		P > F && (P = F);
		...
		if (!O && ("line" == g || "smoothedLine" == g || "step" == g))
			if (1 == d.length && ("step" != g && "none" == this.bullet)
					&& (this.bullet = "round", this.resetBullet = !0), Fa
					|| void 0 != ya) {
				var Aa = T;
				Aa > f.max && (Aa = f.max);
				Aa < f.min && (Aa = f.min);
				...
				m
						? (X = k, Ya = Math.abs(nb - ta), $a = k, ab = Math
								.abs(Qa - ta), Pa = Za = 0, f.reversed
								? (Na = 0, Oa = ta)
								: (Na = ta, Oa = 0))
						: (Ya = j, X = Math.abs(nb - ta), ab = j, $a = Math
								.abs(Qa - ta), Oa = Na = 0, f.reversed
								? (Pa = l, Za = ta)
								: Pa = ta + 1)
			}
		var ua = Math.round;
		...
		var ha = [], ia = [], Ia = !1;
		if ("line" == g || "step" == g || "smoothedLine" == g)
			if (this.stackable && "regular" == z || "100%" == z
					|| this.fillToGraph)
				Ia = !0;
		for (L = I; L <= G; L++) {
			E = d[L];
			...
			if (sa) {
				S = !this.stackable || "none" == z || "3d" == z
						? sa.value
						: sa.close;
				if ("candlestick" == g || "ohlc" == g)
					S = sa.close, Ua = sa.low, Ba = f.getCoordinate(Ua), Ta = sa.high, Ca = f
							.getCoordinate(Ta);
				ja = sa.open;
				B = f.getCoordinate(S);
				...
				-1E5 > oa && (oa = -1E5);
				oa > j + 1E5 && (oa = j + 1E5);
				m ? (D = B, Q = M, M = B = oa, isNaN(ja) && !this.fillToGraph
						&& (Q = U), Ra = Ba, Sa = Ca) : (Q = D = oa, isNaN(ja)
						&& !this.fillToGraph && (M = U));
				switch (g) {
					case "line" :
						isNaN(S)
								? p
										|| (this.drawLineGraph(r, q, ha, ia), r = [], q = [], ha = [], ia = [])
								: (A.isNegative = S < T ? !0 : !1, r.push(D), q
										.push(B), Y = D, ba = B, pa = D, qa = B, Ia
										&& (!isNaN(M) && !isNaN(Q))
										&& (ha.push(Q), ia.push(M)));
						break;
					case "smoothedLine" :
						isNaN(S)
								? p
										|| (this
												.drawSmoothedGraph(r, q, ha, ia), r = [], q = [], ha = [], ia = [])
								: (A.isNegative = S < T ? !0 : !1, r.push(D), q
										.push(B), Y = D, ba = B, pa = D, qa = B, Ia
										&& (!isNaN(M) && !isNaN(Q))
										&& (ha.push(Q), ia.push(M)));
					...
					case "step" :
						isNaN(S)
								? p
										|| (t = NaN, this.drawLineGraph(r, q,
												ha, ia), r = [], q = [], ha = [], ia = [])
								: (A.isNegative = S < T ? !0 : !1, m
										? (isNaN(u)
												|| (r.push(u), q.push(B - wa)), q
												.push(B - wa), r.push(D), q
												.push(B + Ka), r.push(D), Ia
												&& (!isNaN(M) && !isNaN(Q))
												&& (ha.push(Q), ia.push(M - wa), ha
														.push(Q), ia.push(M
														+ Ka)))
										: (isNaN(t)
												|| (q.push(t), r.push(D - wa)), r
												.push(D - wa), q.push(B), r
												.push(D + Ka), q.push(B), Ia
												&& (!isNaN(M) && !isNaN(Q))
												&& (ha.push(Q - wa), ia.push(M), ha
														.push(Q + Ka), ia
														.push(M))), u = D, t = B, Y = D, ba = B, pa = D, qa = B);
						break;
					case "column" :
						la = na;
						...
						if (!isNaN(S)) {
							S < T
									? (A.isNegative = !0, Fa && (va = Fa), void 0 != ya
											&& (na = ya))
									: A.isNegative = !1;
							...
							if (!(S < ob && ja < ob || S > pb && ja > pb))
								if (m) {
									...
									Z += Cb - J;
									Z = AmCharts.fitToBounds(Z, -J, j - J + y
													* ea);
									if (K < k
											&& 0 < H
											&& (ka = new AmCharts.Cuboid(e, Z,
													H, y, x, va, Ja, N, la, V,
													W, s, m), "bottom" != C))
										if (C = f.reversed ? "left" : "right", 0 > S)
									...
									Z += Db - K;
									Z = AmCharts.fitToBounds(Z, -K + x * ea, k
													- K);
									if (J < j + ea * y && 0 < H)
										if (ka = new AmCharts.Cuboid(e, H, Z,
												y, x, va, Ja, N, la,
												this.lineAlpha, W, s, m), 0 > S
												&& "middle" != C)
											C = "bottom";
										else if (C = ma, "regular" == z
												|| "100%" == z)
											ba += this.dy
								}
							if (ka
									&& (ra = ka.set, ra.translate(J, K), this.columnsSet
											.push(ra), A.url
											&& ra.setAttr("cursor", "pointer"), !O)) {
								"none" == z
										&& (w = m
												? (this.end + 1 - L) * v - b
												: v * L + b);
								"3d" == z
										&& (m
												? (w = (v - b)
														* (this.end + 1 - L), Y += y
														* this.columnIndex, pa += y
														* this.columnIndex, A.y += y
														* this.columnIndex)
												: (w = (v - b) * (L + 1), Y += 3, ba += x
														* this.columnIndex + 7, qa += x
														* this.columnIndex, A.y += x
														* this.columnIndex));
								if ("regular" == z || "100%" == z)
									C = "middle", w = m
											? 0 < sa.value
					...
					case "candlestick" :
						if (!isNaN(ja) && !isNaN(Ta) && !isNaN(Ua) && !isNaN(S)) {
							var Va, bb;
							S < ja
									&& (A.isNegative = !0, Fa && (va = Fa), Ha
											&& (Ja = Ha), void 0 != ya
											&& (na = ya));
							la = na;
							void 0 != A.lineColor && (la = A.lineColor);
							if (m) {
								if (K = B - h / 2, J = Q, H = h, K + H > k
										&& (H = k - K), 0 > K
										&& (H += K, K = 0), K < k && 0 < H) {
									var cb, db;
									S > ja
									...
									B < k
											&& 0 < B
											&& (Va = AmCharts.line(e, cb,
													[B, B], la, V, N), bb = AmCharts
													.line(e, db, [B, B], la, V,
															N));
									Z = D - Q;
									ka = new AmCharts.Cuboid(e, Z, H, y, x, va,
											Ga, N, la, V, W, s, m)
								}
							} else if (J = D - h / 2, K = M + N / 2, H = h, J
									+ H > j
									&& (H = j - J), 0 > J && (H += J, J = 0), Z = B
									- M, J < j && 0 < H) {
								var ka = new AmCharts.Cuboid(e, H, Z, y, x, va,
										Ja, N, la, V, W, s, m), eb, fb;
								S > ja ? (eb = [B, Ca], fb = [M, Ba]) : (eb = [
										M, Ca], fb = [B, Ba]);
								D < j
										&& 0 < D
										&& (Va = AmCharts.line(e, [D, D], eb,
												la, V, N), bb = AmCharts.line(
												e, [D, D], fb, la, V, N))
							}
							ka
									&& (ra = ka.set, da.push(ra), ra.translate(
											J, K), A.url
											&& ra.setAttr("cursor", "pointer"), Va
											&& (da.push(Va), da.push(bb)), Y = D, ba = B, pa = D, qa = B, O
											|| (A.x = m ? K + H / 2 : J + H / 2, this
													.animateColumns(ka, L, D,
															Q, B, M), this
													.addListeners(ra, A)))
						}
						break;
					case "ohlc" :
						if (!isNaN(ja) && !isNaN(Ta) && !isNaN(Ua) && !isNaN(S)) {
							S < ja
									&& (A.isNegative = !0, void 0 != ya
											&& (na = ya));
							var gb, hb, ib;
							if (m) {
								var jb = B - h / 2, jb = AmCharts.fitToBounds(
										jb, 0, k), qb = AmCharts.fitToBounds(B,
										0, k), kb = B + h / 2, kb = AmCharts
										.fitToBounds(kb, 0, k);
								hb = AmCharts.line(e, [Q, Q], [jb, qb], na, V,
										N, ca);
								0 < B
										&& B < k
										&& (gb = AmCharts.line(e, [Ra, Sa], [B,
														B], na, V, N, ca));
								ib = AmCharts.line(e, [D, D], [qb, kb], na, V,
										N, ca)
							} else {
								var lb = D - h / 2, lb = AmCharts.fitToBounds(
										lb, 0, j), rb = AmCharts.fitToBounds(D,
										0, j), mb = D + h / 2, mb = AmCharts
										.fitToBounds(mb, 0, j);
								hb = AmCharts.line(e, [lb, rb], [M, M], na, V,
										N, ca);
								0 < D
										&& D < j
										&& (gb = AmCharts.line(e, [D, D], [Ba,
														Ca], na, V, N, ca));
								ib = AmCharts.line(e, [rb, mb], [B, B], na, V,
										N, ca)
							}
							da.push(hb);
							da.push(gb);
				...
				if (!O && !isNaN(S)) {
					...
					if (this.end - this.start <= sb || 0 === sb) {
						...
						if (tb) {
							var $ = this.createLabel(A, 0, 0, tb), xa = 0, za = 0, ub = $
									.getBBox(), Wa = ub.width, Xa = ub.height;
							switch (C) {
								case "left" :
									xa = -(Wa / 2 + Da / 2 + 3);
									break;
						...
						if ("column" == g && "regular" == z || "100%" == z) {
							...
							if (wb) {
								...
								Ab && Ab.remove();
								m ? (Ma = B, La = 0 > S ? D - yb / 2 - 2 : D
										+ yb / 2 + 3) : (La = D, Ma = 0 > S ? B
										+ zb / 2 : B - zb / 2 - 3);
								Ea.translate(La, Ma);
								f.totals[L] = Ea;
								m
		...
		if ("line" == g || "step" == g || "smoothedLine" == g)
			"smoothedLine" == g ? this.drawSmoothedGraph(r, q, ha, ia) : this
					.drawLineGraph(r, q, ha, ia), O || this.launchAnimation()
	},
	animateColumns : function(a, b) {
		...
		0 < e
				&& !d.animationPlayed
				&& (d.seqAn
						? (a.set.hide(), d.animationArray.push(a), e = setTimeout(
								function() {
									d.animate.call(d)
								}, 1E3 * e / (d.end - d.start + 1)
										* (b - d.start)), d.timeOuts.push(e))
						: d.animate(a))
	},
	...
	drawLineGraph : function(a, b, d, e) {
		if (1 < a.length) {
			...
			f.push(h);
			f.push(j);
			var k = this.lineAlpha, l = this.lineThickness, m = this.dashLength, f = this.fillAlphas, n = this.fillColors, s = this.negativeLineColor, p = this.negativeFillColors, r = this.negativeFillAlphas, q = this.baseCoord, u = AmCharts
					.line(g, a, b, this.lineColor, k, l, m, !1, !0);
			h.push(u);
			void 0 !== s
					&& (k = AmCharts.line(g, a, b, s, k, l, m, !1, !0), j
							.push(k));
			if (0 < f
					&& (k = a.join(";").split(";"), l = b.join(";").split(";"), "serial" == this.chartType
							&& (0 < d.length ? (d.reverse(), e.reverse(), k = a
									.concat(d), l = b.concat(e)) : this.rotate
									? (l.push(l[l.length - 1]), k.push(q), l
											.push(l[0]), k.push(q), l
											.push(l[0]), k.push(k[0]))
									: (k.push(k[k.length - 1]), l.push(q), k
											.push(k[0]), l.push(q), k
											.push(a[0]), l.push(l[0]))), a = AmCharts
							.polygon(g, k, l, n, f, 0, 0, 0,
									this.gradientRotation), h.push(a), p
							|| void 0 !== s))
				isNaN(r) && (r = f), p || (p = s), g = AmCharts.polygon(g, k,
						l, p, r, 0, 0, 0, this.gradientRotation), j.push(g);
			this.applyMask(j, h)
		}
	},
	applyMask : function(a, b) {
		var d = a.length();
		"serial" == this.chartType && !this.scrollbar
				&& (this.positiveClip(b), 0 < d && this.negativeClip(a))
	},
	drawSmoothedGraph : function(a, b, d, e) {
		if (1 < a.length) {
			...
			f.push(h);
			f.push(j);
			var k = this.lineAlpha, l = this.lineThickness, f = this.dashLength, m = this.fillAlphas, n = this.fillColors, s = this.negativeLineColor, p = this.negativeFillColors, r = this.negativeFillAlphas, q = this.baseCoord, u = new AmCharts.Bezier(
					g, a, b, this.lineColor, k, l, n, 0, f);
			h.push(u.path);
			void 0 !== s
					&& (k = new AmCharts.Bezier(g, a, b, s, k, l, n, 0, f), j
							.push(k.path));
			if (0 < m
					&& (l = a.join(";").split(";"), u = b.join(";").split(";"), k = "", 0 < d.length
							? (d.reverse(), e.reverse(), l = a.concat(d), u = b
									.concat(e))
							: (this.rotate ? (k += " L" + q + ","
									+ b[b.length - 1], k += " L" + q + ","
									+ b[0]) : (k += " L" + a[a.length - 1]
									+ "," + q, k += " L" + a[0] + "," + q), k += " L"
									+ a[0] + "," + b[0]), d = new AmCharts.Bezier(
							g, l, u, NaN, 0, 0, n, m, f, k), h.push(d.path), p
							|| void 0 !== s))
				r || (r = m), p || (p = s), a = new AmCharts.Bezier(g, a, b,
						NaN, 0, 0, p, r, f, k), j.push(a.path);
			this.applyMask(j, h)
		}
	},
	launchAnimation : function() {
		...
		if (0 < b && !a.animationPlayed) {
			...
			a.seqAn ? (b = setTimeout(function() {
					...
					}, 1E3 * a.index * b), a.timeOuts.push(b)) : a
					.animateGraphs()
		}
	},
	animateGraphs : function() {
		...
		b
				&& (this.rotate
						? (b.translate(-1E3, f), d.translate(-1E3, f))
						: (b.translate(e, -1E3), d.translate(e, -1E3)), b
						.animate({
									opacity : 1,
									translate : e + "," + f
								}, g, a), d.animate({
	...
	animate : function(a) {
		...
		b = b.startDuration;
		a
				&& (this.rotate ? a.animateWidth(b, d) : a.animateHeight(b, d), a.set
						.show())
	},
	legendKeyColor : function() {
		var a = this.legendColor, b = this.lineAlpha;
		void 0 === a
				&& (a = this.lineColor, 0 === b && (b = this.fillColors)
	...
	legendKeyAlpha : function() {
		...
		void 0 === a
				&& (a = this.lineAlpha, 0 === a && this.fillAlphas
						&& (a = this.fillAlphas), 0 === a
						&& (a = this.bulletAlpha), 0 === a && (a = 1));
		return a
	},
	createBullet : function(a, b, d) {
		...
		if ("none" != this.bullet || a.bullet) {
			...
			switch (f) {
				case "round" :
					...
					break;
				case "square" :
					j = AmCharts.polygon(e, [0, g, g, 0], [0, 0, g, g], n, s,
							h, l, m);
					b -= g / 2;
					d -= g / 2;
					k = -g / 2;
		...
		if (this.customBullet || a.customBullet)
			l = this.customBullet, a.customBullet && (l = a.customBullet), l
					&& (j && j.remove(), "function" == typeof l
							? (j = new l, j.chart = this.chart, a.bulletConfig
									&& (j.availableSpace = d, j.graph = this, a.bulletConfig.minCoord = this.minCoord
											- d, j.bulletConfig = a.bulletConfig), j
									.write(e), j = j.set)
							: (this.chart.path && (l = this.chart.path + l), j = e
									.image(l, 0, 0, g, g), this.centerCustomBullets
									&& (b -= g / 2, d -= g / 2, f -= g / 2, h -= g
											/ 2)));
		if (j) {
			a.url && j.setAttr("cursor", "pointer");
			if ("serial" == this.chartType
					&& (b - f < k || b - f > this.width || d < -g / 2 || d - h > this.height))
				j.remove(), j = null;
			j
					&& (this.bulletSet.push(j), j.translate(b, d), this
							.addListeners(j, a), this.allBullets.push(j))
		}
		return g
	},
	...
	handleRollOver : function(a) {
		if (a) {
			...
			b.chartCursor
					...
					&& (d = !1, !b.chartCursor.valueBalloonsEnabled
							&& this.showBalloon && (d = !0));
			d
					&& (d = b.formatString(this.balloonText, a, a.graph), d = AmCharts
							.cleanFromEmpty(d), a = b.getBalloonColor(this, a), b.balloon.showBullet = !1, b.balloon.pointerOrientation = "V", b
							.showBalloon(d, a, !0))
		}
	},
	handleRollOut : function(a) {
		...
		a
				&& (a = {
					...
					target : this,
					chart : this.chart
				}, this.fire("rollOutGraphItem", a), this.chart.fire(
						"rollOutGraphItem", a))
	},
	...
	handleRightClick : function(a) {
		a
				&& (a = {
					...
					target : this,
					chart : this.chart
				}, this.fire("rightClickGraphItem", a), this.chart.fire(
						"rightClickGraphItem", a))
	},
	handleDoubleClick : function(a) {
		a
				&& (a = {
					...
					target : this,
					chart : this.chart
				}, this.fire("doubleClickGraphItem", a), this.chart.fire(
						"doubleClickGraphItem", a))
	},
	zoom : function(a, b) {
		this.start = a;
		this.end = b;
...
AmCharts.ChartCursor = AmCharts.Class({
	...
	draw : function() {
		...
		if (a.valueBalloonsEnabled)
			for (d = 0; d < b.graphs.length; d++)
				e = new AmCharts.AmBalloon, e.chart = b, AmCharts
						.copyProperties(b.balloon, e), b.graphs[d].valueBalloon = e;
	...
	createCursor : function() {
		var a = this.chart, b = this.cursorAlpha, d = a.categoryAxis, e = d.position, f = d.inside, g = d.axisThickness, h = this.categoryBalloon, j, k, l = a.dx, m = a.dy, n = this.x, s = this.y, p = this.width, r = this.height, a = a.rotate, q = d.tickLength;
		h.pointerWidth = q;
		a ? (j = [0, p, p + l], k = [0, 0, m]) : (j = [l, 0, 0], k = [m, 0, r]);
		this.line = b = AmCharts.line(this.container, j, k, this.cursorColor,
				b, 1);
		this.set.push(b);
		a
				? (f && (h.pointerWidth = 0), "right" == e ? f ? h.setBounds(n,
						s + m, n + p + l, s + r + m) : h.setBounds(n + p + l
								+ g, s + m, n + p + 1E3, s + r + m) : f ? h
						.setBounds(n, s, p + n, r + s) : h.setBounds(-1E3,
						-1E3, n - q - g, s + r + 15))
				: (h.maxWidth = p, d.parseDates && (q = 0, h.pointerWidth = 0), "top" == e
						? f ? h.setBounds(n + l, s + m, p + l + n, r + s) : h
								.setBounds(n + l, -1E3, p + l + n, s + m - q
												- g)
						: f ? h.setBounds(n, s, p + n, r + s - q) : h
								.setBounds(n, s + r + q + g - 1, n + p, s + r
												+ q + g));
		this.hideCursor()
	},
	createCrosshair : function() {
		var a = this.cursorAlpha, b = this.container, d = AmCharts.line(b, [0,
						0], [0, this.height], this.cursorColor, a, 1), a = AmCharts
				.line(b, [0, this.width], [0, 0], this.cursorColor, a, 1);
		this.set.push(d);
		this.set.push(a);
		this.vLine = d;
		this.hLine = a;
	...
	detectMovement : function() {
		...
		if (a.mouseIsOver) {
			...
			0 < b && b < this.width && 0 < d && d < this.height
					? (this.drawing ? this.rolledOver
							|| a.setMouseCursor("crosshair") : this.pan
							&& (this.rolledOver || a.setMouseCursor("move")), this.rolledOver = !0, this
							.setPosition())
					: this.rolledOver
	...
	getMousePosition : function() {
		...
		a = this.chart;
		this.rotate ? (a = a.mouseY - this.y, 0 > a && (a = 0), a > d
				&& (a = d)) : (a = a.mouseX - this.x, 0 > a && (a = 0), a > b
				&& (a = b));
		return a
	},
	updateCrosshair : function() {
		var a = this.chart, b = a.mouseX - this.x, d = a.mouseY - this.y, e = this.vLine, f = this.hLine, b = AmCharts
				.fitToBounds(b, 0, this.width), d = AmCharts.fitToBounds(d, 0,
				this.height);
		0 < this.cursorAlpha
				&& (e.show(), f.show(), e.translate(b, 0), f.translate(0, d));
		this.zooming
				&& (a.hideXScrollbar && (b = NaN), a.hideYScrollbar
						&& (d = NaN), this.updateSelectionSize(b, d));
	...
	updateSelectionSize : function(a, b) {
		...
		isNaN(a)
				|| (d > a && (f = a, h = d - a), d < a && (f = d, h = a - d), d == a
						&& (f = a, h = 0));
		isNaN(b)
				|| (e > b && (g = b, j = e - b), e < b && (g = e, j = b - e), e == b
						&& (g = b, j = 0));
		0 < h
				&& 0 < j
				&& (d = AmCharts.rect(this.container, h, j, this.cursorColor,
						this.selectionAlpha), d.translate(f + this.x, g
								+ this.y), this.selection = d)
	},
	...
	arrangeBalloons2 : function() {
		...
		for (f = 0; f < a.length; f++) {
			...
			0 < f
					&& b - h < e + 3
					&& (g.setBounds(d, e + 3, d + this.width, e + h + 3), g
							.draw());
			g.set && g.set.show();
			e = g.bottom
		}
		...
		for (d = 0; d < b.length; d++) {
			...
			if (!e.hidden && e.balloonText) {
				...
				if (!isNaN(g)) {
					...
					e = AmCharts
							.circle(a, this.bulletSize / 2, this.chart
											.getBalloonColor(e, f),
									e.cursorBulletAlpha);
					e.translate(j, g);
	...
	zoom : function(a, b, d, e) {
		...
		var g;
		this.rotate
				? this.selectionPosY = g = f.mouseY
				: this.selectionPosX = g = f.mouseX;
		this.start = a;
		this.end = b;
		this.startTime = d;
		this.endTime = e;
		...
		g = this.width;
		var j = this.height;
		h.parseDates && !h.equalSpacing ? (a = e - d + h.minDuration(), a = f
				? j / a
				: g / a) : a = f ? j / (b - a) : g / (b - a);
		this.stepWidth = a;
		this.setPosition();
		...
		if ("cursor" == this.type) {
			if (AmCharts.ifArray(this.data)) {
				...
				if ((a != this.previousMousePosition || !0 === this.zoomed || this.oneBalloonOnly)
					...
					if (d != this.previousIndex || this.zoomed
							|| "mouse" == this.cursorPosition
							|| this.oneBalloonOnly)
						this.updateCursor(d, b), this.zoomed = !1
				}
	...
	updateCursor : function(a, b) {
		...
		this.drawingNow
				&& (AmCharts.remove(this.drawingLine), this.drawingLine = AmCharts
						.line(this.container, [this.x + this.drawStartX,
										this.x + e], [this.y + this.drawStartY,
										this.y + f], this.cursorColor, 1, 1));
		if (this.enabled) {
			void 0 === b && (b = !0);
			this.index = a;
			var g = d.categoryAxis, h = d.dx, j = d.dy, k = this.x, l = this.y, m = this.width, n = this.height, s = this.data[a];
			if (s) {
				var p = s.x[g.id], r = d.rotate, q = g.inside, u = this.stepWidth, t = this.categoryBalloon, v = this.firstTime, w = this.lastTime, y = this.cursorPosition, x = g.position, z = this.zooming, C = this.panning, I = d.graphs, G = g.axisThickness;
				if (d.mouseIsOver || z || C || this.forceShow)
					if (this.forceShow = !1, C) {
						var h = this.panClickPos, d = this.panClickEndTime, z = this.panClickStartTime, O = this.panClickEnd, k = this.panClickStart, e = (r
								? h - f
								: h - e)
								/ u;
						...
						0 !== e
								&& (h = {
									type : "zoomed",
									target : this
								}, h.chart = this.chart, g.parseDates
										&& !g.equalSpacing
										? (d + e > w && (e = w - d), z + e < v
												&& (e = v - z), h.start = z + e, h.end = d
												+ e, this.fire(h.type, h))
										: O + e >= this.data.length
												|| 0 > k + e
												|| (h.start = k + e, h.end = O
														+ e, this.fire(h.type,
														h)))
						...
						0 < this.cursorAlpha
								&& (v = this.line, r
										? v.translate(0, p + j)
										: v.translate(p, 0), v.show());
						this.linePos = r ? p + j : p;
						z
								&& (r ? this.updateSelectionSize(NaN, p) : this
										.updateSelectionSize(p, NaN));
						v = !0;
						z && (v = !1);
						this.categoryBalloonEnabled && v
								? (r
										? (q
												&& ("right" == x ? t.setBounds(
														k, l + j, k + m + h, l
												...
												: q
														...
														: t.setPosition(k - G,
																l + p))
										: "top" == x ? q ? t.setPosition(k + p
														+ h, l + j) : t
												.setPosition(k + p + h, l + j
																- G + 1) : q
												? t.setPosition(k + p, l + n)
												: t.setPosition(k + p, l + n
																+ G - 1), g.parseDates
										? (g = AmCharts.formatDate(s.category,
												this.categoryBalloonDateFormat), -1 != g
												.indexOf("fff")
												&& (g = AmCharts
														.formatMilliseconds(g,
																s.category)), t
												.showBalloon(g))
										: t.showBalloon(s.category))
								: t.hide();
						I && this.bulletsEnabled && this.showBullets();
						this.destroyValueBalloons();
						if (I && this.valueBalloonsEnabled && v
								&& d.balloon.enabled) {
							...
							if (this.oneBalloonOnly) {
								...
								for (g = 0; g < I.length; g++)
									u = I[g], u.showBalloon
											&& (!u.hidden && u.balloonText)
											&& (t = s.axes[u.valueAxis.id].graphs[u.id], w = t.y, isNaN(w)
													|| (r
															? Math.abs(e - w) < j
																	&& (j = Math
																			.abs(e
															...
															: Math.abs(f - w) < j
																	&& (j = Math
																			.abs(f
																					- w), O = u)));
								this.mostCloseGraph
										&& (O = this.mostCloseGraph)
							}
							for (g = 0; g < I.length; g++)
								if (u = I[g], !(this.oneBalloonOnly && u != O)
										&& (u.showBalloon && !u.hidden && u.balloonText)
										&& (t = s.axes[u.valueAxis.id].graphs[u.id], w = t.y, !isNaN(w))) {
									p = t.x;
									q = !0;
									if (r) {
										if (j = w, 0 > p || p > n)
											q = !1
									} else if (j = p, p = w, 0 > j || j > m + h)
										q = !1;
									q
											&& (q = u.valueBalloon, x = d
													.getBalloonColor(u, t), q
													.setBounds(k, l, k + m, l
																	+ n), q.pointerOrientation = "H", q
													.changeColor(x), void 0 !== u.balloonAlpha
													&& (q.fillAlpha = u.balloonAlpha), void 0 !== u.balloonTextColor
													&& (q.color = u.balloonTextColor), q
													.setPosition(j + k, p + l), u = d
													.formatString(
															u.balloonText, t, u), "" !== u
													&& q.showBalloon(u), !r
													&& q.set && q.set.hide(), v
						...
						b
								? (h = {
									type : "changed"
								}, h.index = a, h.target = this, h.chart = this.chart, h.zooming = z, h.mostCloseGraph = O, h.position = r
										? f
										: e, h.target = this, d.fire("changed",
										h), this.fire("changed", h), this.skipZoomDispatch = !1)
								: (this.skipZoomDispatch = !0, d
										.updateLegendValues(a));
				...
				if (this.pan)
					...
					if ("cursor" == this.type)
						this.rotate
								...
								: this.selectionPosX = f = e, 2 > Math.abs(f
								- this.initialMouse)
								&& this.fromIndex == this.index
								|| (this.index < this.fromIndex
										? (d.end = this.fromIndex, d.start = this.index)
										: (d.end = this.index, d.start = this.fromIndex), f = a.categoryAxis, f.parseDates
										&& !f.equalSpacing
										&& (d.start = b[d.start].time, d.end = a
												.getEndTime(b[d.end].time)), this.skipZoomDispatch
										|| this.fire(d.type, d));
					else {
						var h = this.initialMouseX, j = this.initialMouseY;
						3 > Math.abs(e - h)
								&& 3 > Math.abs(f - j)
								|| (b = Math.min(h, e), g = Math.min(j, f), e = Math
										.abs(h - e), f = Math.abs(j - f), a.hideXScrollbar
										&& (b = 0, e = this.width), a.hideYScrollbar
										&& (g = 0, f = this.height), d.selectionHeight = f, d.selectionWidth = e, d.selectionY = g, d.selectionX = b, this.skipZoomDispatch
										|| this.fire(d.type, d))
					}
	...
	handleMouseDown : function(a) {
		if (this.zoomable || this.pan || this.drawing) {
			var b = this.rotate, d = this.chart, e = d.mouseX - this.x, f = d.mouseY
					- this.y;
			if (0 < e && e < this.width && 0 < f && f < this.height
					|| "fake" == a)
				this.setPosition(), this.selectWithoutZooming
						&& AmCharts.remove(this.selection), this.drawing
						? (this.drawStartY = f, this.drawStartX = e, this.drawingNow = !0)
						: this.pan
								? (this.zoomable = !1, d.setMouseCursor("move"), this.panning = !0, this.panClickPos = b
										? f
										: e, this.panClickStart = this.start, this.panClickEnd = this.end, this.panClickStartTime = this.startTime, this.panClickEndTime = this.endTime)
								: this.zoomable
										&& ("cursor" == this.type
												? (this.fromIndex = this.index, b
														? (this.initialMouse = f, this.selectionPosY = this.linePos)
														: (this.initialMouse = e, this.selectionPosX = this.linePos))
												: (this.initialMouseX = e, this.initialMouseY = f, this.selectionPosX = e, this.selectionPosY = f), this.zooming = !0)
		}
	}
});
AmCharts.SimpleChartScrollbar = AmCharts.Class({
	...
	draw : function() {
		...
		var g, h;
		d
				? (g = a.scrollbarHeight, h = e.plotAreaHeight)
				: (h = a.scrollbarHeight, g = e.plotAreaWidth);
		a.width = g;
		if ((a.height = h) && g) {
			var j = AmCharts
					.rect(b, g, h, a.backgroundColor, a.backgroundAlpha);
			a.bg = j;
			f.push(j);
			...
			j = AmCharts.rect(b, g, h, a.selectedBackgroundColor,
			...
			g = e.pathToImages;
			d
					? (j = g + "dragIconH.gif", g = a.dragIconWidth, d = a.dragIconHeight)
					: (j = g + "dragIcon.gif", d = a.dragIconWidth, g = a.dragIconHeight);
			h = b.image(j, 0, 0, d, g);
			var j = b.image(j, 0, 0, d, g), k = 10, l = 20;
			e.panEventsEnabled && (k = 25, l = a.scrollbarHeight);
			var m = AmCharts.rect(b, k, l, "#000", 0.005), n = AmCharts.rect(b,
					k, l, "#000", 0.005);
	...
	updateScrollbarSize : function(a, b) {
		...
		this.rotate
				? (e = 0, f = a, g = this.width + 1, h = b - a, d.setAttr(
						"height", b - a), d.setAttr("y", f))
				: (e = a, f = 0, g = b - a, h = this.height + 1, d.setAttr(
						"width", b - a), d.setAttr("x", e));
		this.clipAndUpdate(e, f, g, h)
	},
	updateScrollbar : function() {
		var a, b = !1, d, e, f = this.x, g = this.y, h = this.dragger, j = this
				.getDBox();
		d = j.x + f;
		e = j.y + g;
		...
		m.mouseIsOver
				&& (this.dragging
						&& (m = this.initialCoord, l ? (a = m + (r - a), 0 > a
								&& (a = 0), m = s - j, a > m && (a = m), h
								.setAttr("y", a)) : (a = m + (p - a), 0 > a
								&& (a = 0), m = n - k, a > m && (a = m), h
								.setAttr("x", a))), this.resizingRight
						&& (l
								? (a = r - e, a + e > s + g && (a = s - e + g), 0 > a
										? (this.resizingRight = !1, b = this.resizingLeft = !0)
										: (0 === a && (a = 0.1), h.setAttr(
												"height", a)))
								: (a = p - d, a + d > n + f && (a = n - d + f), 0 > a
										? (this.resizingRight = !1, b = this.resizingLeft = !0)
										: (0 === a && (a = 0.1), h.setAttr(
												"width", a)))), this.resizingLeft
						&& (l
								? (d = e, e = r, e < g && (e = g), e > s + g
										&& (e = s + g), a = !0 === b
										? d - e
										: j + d - e, 0 > a
										? (this.resizingRight = !0, this.resizingLeft = !1, h
												.setAttr("y", d + j - g))
										: (0 === a && (a = 0.1), h.setAttr("y",
												e - g), h.setAttr("height", a)))
								: (e = p, e < f && (e = f), e > n + f
										&& (e = n + f), a = !0 === b
										? d - e
										: k + d - e, 0 > a
										? (this.resizingRight = !0, this.resizingLeft = !1, h
												.setAttr("x", d + k - f))
										: (0 === a && (a = 0.1), h.setAttr("x",
												e - f), h.setAttr("width", a)))), this
						.clipDragger(!0))
	},
	clipDragger : function(a) {
		var b = this.getDBox(), d = b.x, e = b.y, f = b.width, b = b.height, g = !1;
		if (this.rotate) {
			if (d = 0, f = this.width + 1, this.clipY != e || this.clipH != b)
				g = !0
		} else if (e = 0, b = this.height + 1, this.clipX != d
				|| this.clipW != f)
			g = !0;
		g
				&& (this.clipAndUpdate(d, e, f, b), a
						&& (this.updateOnReleaseOnly || this
	...
	updateDragIconPositions : function() {
		...
		this.rotate
				? (g = this.dragIconWidth, h = this.dragIconHeight, e
						.translate((j - h) / 2, d - g / 2), f.translate((j - h)
								/ 2, d + a.height - g / 2))
				: (g = this.dragIconHeight, h = this.dragIconWidth, e
						.translate(b - h / 2, (j - g) / 2), f.translate(b + -h
								/ 2 + a.width, (j - g) / 2))
	},
	...
	hideDragIcons : function() {
		!this.resizingLeft
				&& (!this.resizingRight && !this.dragging)
				&& (this.hideResizeGrips
						&& (this.iconLeft.hide(), this.iconRight.hide()), this
						.removeCursors())
	},
	...
	handleDragStop : function() {
		this.updateOnReleaseOnly
				&& (this.updateScrollbar(), this.skipEvent = !1, this
						.dispatchScrollbarEvent());
		this.dragging = !1;
	...
	iconRollOver : function() {
		this.rotate ? this.chart.setMouseCursor("n-resize") : this.chart
				.setMouseCursor("e-resize");
		this.handleMouseOver()
	},
	getDBox : function() {
	...
	handleBgClick : function() {
		if (!this.resizingRight && !this.resizingLeft) {
			...
			k
					? (a = "y", b = b.mouseY - f / 2 - h, b = AmCharts
							.fitToBounds(b, 0, this.height - f))
					: (a = "x", b = b.mouseX - g / 2 - j, b = AmCharts
							.fitToBounds(b, 0, this.width - g));
			this.updateOnReleaseOnly
					? (this.skipEvent = !1, e.setAttr(a, b), this
							.dispatchScrollbarEvent(), this.clipDragger())
					: (b = Math.round(b), k ? e.animate({
								y : b
							}, d, ">") : e.animate({
								x : b
							}, d, ">"))
...
AmCharts.ChartScrollbar = AmCharts.Class({
	...
	init : function() {
		...
		this.graph
				&& (a = this.valueAxis, a
						|| (this.valueAxis = a = new AmCharts.ValueAxis, a.visible = !1, a.scrollbar = !0, a.axisItemRenderer = AmCharts.RecItem, a.axisRenderer = AmCharts.RecAxis, a.guideFillRenderer = AmCharts.RecFill, a.labelsEnabled = !1, a.chart = b), b = this.unselectedGraph, b
						|| (b = new AmCharts.AmGraph, b.scrollbar = !0, this.unselectedGraph = b, b.negativeBase = this.graph.negativeBase), b = this.selectedGraph, b
						|| (b = new AmCharts.AmGraph, b.scrollbar = !0, this.selectedGraph = b, b.negativeBase = this.graph.negativeBase));
	...
	dispatchScrollbarEvent : function() {
		if (this.skipEvent)
			...
			if (g.parseDates && !g.equalSpacing) {
				if (a = e.firstTime, g.minDuration(), e = Math.round(b / h) + a, a = this.dragging
						? e + this.timeDifference
						: Math.round((b + d) / h) + a, e > a && (e = a), e != this.startTime
						|| a != this.endTime)
					this.startTime = e, this.endTime = a, f.start = e, f.end = a, f.startDate = new Date(e), f.endDate = new Date(a), this
							.fire(f.type, f)
			} else if (g.startOnAxis || (b += h / 2), d -= this.stepWidth / 2, e = g
					.xToIndex(b), b = g.xToIndex(b + d), e != this.start
					|| this.end != b)
				g.startOnAxis
						&& (this.resizingRight && e == b && b++, this.resizingLeft
								&& e == b && (0 < e ? e-- : b = 1)), this.start = e, this.end = this.dragging
						? this.start + this.difference
						: b, f.start = this.start, f.end = this.end, g.parseDates
						&& (a[this.start]
								&& (f.startDate = new Date(a[this.start].time)), a[this.end]
								&& (f.endDate = new Date(a[this.end].time))), this
						.fire(f.type, f)
		}
	},
	zoomScrollbar : function() {
		...
		e.parseDates && !e.equalSpacing
				? (d = e.stepWidth, e = a.firstTime, a = d
						* (this.startTime - e), b = d * (this.endTime - e))
				: (a = d[this.start].x[e.id], b = d[this.end].x[e.id], d = e.stepWidth, e.startOnAxis
						|| (e = d / 2, a -= e, b += e));
		this.stepWidth = d;
	...
	handleBackgroundClick : function() {
		...
		this.dragging
				|| (this.difference = this.end - this.start, this.timeDifference = this.endTime
						- this.startTime, 0 > this.timeDifference
...
AmCharts.wedge = function(a, b, d, e, f, g, h, j, k, l, m) {
	...
	-359.95 > r && (r = -359.95);
	f <= r && (f = r);
	var q = 1 / 180 * Math.PI, r = b + Math.cos(e * q) * j, u = d
			+ Math.sin(-e * q) * s, t = b + Math.cos(e * q) * g, v = d
			+ Math.sin(-e * q) * h, w = b + Math.cos((e + f) * q) * g, y = d
			+ Math.sin((-e - f) * q) * h, x = b + Math.cos((e + f) * q) * j, q = d
			+ Math.sin((-e - f) * q) * s, z = {
	...
	var I;
	p
			&& (r = n(10 * r), t = n(10 * t), w = n(10 * w), x = n(10 * x), u = n(10
					* u), v = n(10 * v), y = n(10 * y), q = n(10 * q), b = n(10
					* b), k = n(10 * k), d = n(10 * d), g *= 10, h *= 10, j *= 10, s *= 10, 1 > Math
					.abs(f)
					&& (1 >= Math.abs(w - t) && 1 >= Math.abs(y - v))
					&& (I = !0));
	f = "";
	if (0 < k) {
		p
				? (path = " M" + r + "," + (u + k) + " L" + t + "," + (v + k), I
						|| (path += " A" + (b - g) + "," + (k + d - h) + ","
								+ (b + g) + "," + (k + d + h) + "," + t + ","
								+ (v + k) + "," + w + "," + (y + k)), path += " L"
						+ x + "," + (q + k), 0 < j
		...
		var G = a.path(
				" M" + r + "," + u + " L" + r + "," + (u + k) + " L" + t + ","
						+ (v + k) + " L" + t + "," + v + " L" + r + "," + u
						+ " Z", void 0, void 0, "1000,1000").attr(z);
		k = a.path(
				" M" + w + "," + y + " L" + w + "," + (y + k) + " L" + x + ","
						+ (q + k) + " L" + x + "," + q + " L" + w + "," + y
						+ " Z", void 0, void 0, "1000,1000").attr(z);
	...
	p ? (I
			|| (f = " A" + n(b - g) + "," + n(d - h) + "," + n(b + g) + ","
					+ n(d + h) + "," + n(t) + "," + n(v) + "," + n(w) + ","
					+ n(y)), g = " M" + n(r) + "," + n(u) + " L" + n(t) + ","
			+ n(v) + f + " L" + n(x) + "," + n(q)) : g = " M" + r + "," + u
			+ " L" + t + "," + v
			+ (" A" + g + "," + h + ",0," + C + ",1," + w + "," + y) + " L" + x
			+ "," + q;
	0 < j
...
AmCharts.adjustLuminosity = function(a, b) {
	...
	6 > a.length
			&& (a = String(a[0]) + String(a[0]) + String(a[1]) + String(a[1])
					+ String(a[2]) + String(a[2]));
	b = b || 0;
	var d = "#", e, f;
	for (f = 0; 3 > f; f++)
		e = parseInt(a.substr(2 * f, 2), 16), e = Math.round(Math.min(Math.max(
						0, e + e * b), 255)).toString(16), d += ("00" + e)
				.substr(e.length);
	return d
};
AmCharts.AmPieChart = AmCharts.Class({
	...
	initChart : function() {
		...
		this.dataChanged
				&& (this.parseData(), this.dispatchDataUpdated = !0, this.dataChanged = !1, this.legend
	...
	drawChart : function() {
		...
		if (AmCharts.ifArray(b)) {
			if (0 < a.realWidth && 0 < a.realHeight) {
				...
				a.realHeight = g;
				var h = AmCharts.toCoordinate, j = h(a.marginLeft, f), k = h(
						a.marginRight, f), l = h(a.marginTop, g)
						+ a.getTitleHeight(), m = h(a.marginBottom, g);
				a.chartDataLabels = [];
				a.ticks = [];
				var n, s, p, r = AmCharts.toNumber(a.labelRadius), q = a
						.measureMaxLabel();
				if (!a.labelText || !a.labelsEnabled)
					r = q = 0;
				n = void 0 === a.pieX ? (f - j - k) / 2 + j : h(a.pieX,
						a.realWidth);
				s = void 0 === a.pieY ? (g - l - m) / 2 + l : h(a.pieY, g);
				p = h(a.radius, f, g);
				a.pullOutRadiusReal = AmCharts.toCoordinate(a.pullOutRadius, p);
				p
						|| (f = 0 <= r ? f - j - k - 2 * q : f - j - k, g = g
								- l - m, p = Math.min(f, g), g < f
								&& (p /= 1 - a.angle / 90, p > f && (p = f)), a.pullOutRadiusReal = AmCharts
								.toCoordinate(a.pullOutRadius, p), p = 0 <= r
								? p - 1.8 * (r + a.pullOutRadiusReal)
								: p - 1.8 * a.pullOutRadiusReal, p /= 2);
				...
				for (m = 0; m < b.length; m++)
					if (f = b[m], !0 !== f.hidden && 0 < f.percents) {
						var k = 360 * -f.percents / 100, q = Math.cos((g + k
								/ 2)
								/ 180 * Math.PI), u = Math.sin((-g - k / 2)
								/ 180 * Math.PI)
								* (l / p), j = {
							fill : f.color,
						...
						j = AmCharts.wedge(e, n, s, g, k, p, l, h, a.depth3D,
								j, a.gradientRatio);
						...
						f.wedge = j;
						f.index = m;
						if (a.labelsEnabled && a.labelText
								&& f.percents >= a.hideLabelsPercent) {
							var v = g + k / 2;
							0 >= v && (v += 360);
							k = r;
							...
							if (0 <= k) {
								...
								w = "middle";
							var v = a.formatString(a.labelText, f), x = f.labelColor;
							void 0 == x && (x = a.color);
							v = AmCharts.text(e, v, x, a.fontFamily,
									a.fontSize, w);
	...
	setDepths : function() {
		...
		for (b = 0; b < a.length; b++) {
			...
			90 >= d && 0 <= d || 360 >= d && 270 < d ? e.toFront() : (270 >= d
					&& 180 < d || 180 >= d && 90 < d)
					&& e.toBack()
		}
	},
	...
	drawTicks : function() {
		...
		for (b = 0; b < a.length; b++)
			if (this.chartDataLabels[b]) {
				var d = a[b], e = d.ty, f = this.radiusReal, e = AmCharts.line(
						this.container,
						[this.pieXReal + d.ix * f, d.tx, d.tx2], [
								this.pieYReal + d.iy * f, e, e],
	...
	arrangeLabels : function() {
		...
		for (e = b - 1; 0 <= e; e--)
			d = a[e], 0 === d.labelQuarter && !d.hidden
					&& this.checkOverlapping(e, d, 0, !0, 0);
		for (e = 0; e < b; e++)
			d = a[e], 1 == d.labelQuarter && !d.hidden
					&& this.checkOverlapping(e, d, 1, !1, 0);
		for (e = b - 1; 0 <= e; e--)
			d = a[e], 2 == d.labelQuarter && !d.hidden
					&& this.checkOverlapping(e, d, 2, !0, 0);
		for (e = 0; e < b; e++)
			d = a[e], 3 == d.labelQuarter && !d.hidden
					&& this.checkOverlapping(e, d, 3, !1, 0)
	},
	checkOverlapping : function(a, b, d, e, f) {
		...
		if (l) {
			...
			!0 === g
					&& 100 > f
					&& (g = b.ty + 3 * b.iy, b.ty = g, l.translate(b.tx2, g), this
							.checkOverlapping(a, b, d, e, f + 1))
		}
	},
	checkOverlappingReal : function(a, b, d) {
		...
		a.labelQuarter == d
				&& (!a.hidden && !b.hidden && g)
				&& (f = f.getBBox(), d = {}, d.width = f.width, d.height = f.height, d.y = a.ty, d.x = a.tx, a = g
						.getBBox(), g = {}, g.width = a.width, g.height = a.height, g.y = b.ty, g.x = b.tx, AmCharts
						.hitTest(d, g)
						&& (e = !0));
		return e
	},
	startSlices : function() {
		...
		for (a = 0; a < this.chartData.length; a++)
			0 < this.startDuration && this.sequencedAnimation ? this
					.setStartTO(a) : this.startSlice(this.chartData[a])
	},
	...
	rollOverSlice : function(a, b) {
		...
		var d = this.innerRadiusReal + (this.radiusReal - this.innerRadiusReal)
				/ 2;
		a.pulled && (d += this.pullOutRadiusReal);
		1 > this.hoverAlpha && a.wedge && a.wedge.attr({
					opacity : this.hoverAlpha
				});
		var e = a.ix * d + this.pieXReal, d = a.iy * d + this.pieYReal, f = this
				.formatString(this.balloonText, a), g = AmCharts
				.adjustLuminosity(a.color, -0.15);
	...
	pullSlice : function(a, b, d) {
		...
		1 == b
				? (a.pulled = !0, this.pullOutOnlyOne
	...
	parseData : function() {
		...
		if (void 0 !== b) {
			...
			for (f = 0; f < d; f++) {
				...
				g.visibleInLegend = AmCharts.toBoolean(
						j[this.visibleInLegendField], !0);
				h = j[this.alphaField];
			...
			for (f = b = 0; f < d; f++)
				g = a[f], g.percents = 100 * (g.value / e), g.percents < this.groupPercent
						&& b++;
			...
			for (f = 0; f < a.length; f++)
				this.pieBaseColor
						? h = AmCharts.adjustLuminosity(this.pieBaseColor, f
										* this.pieBrightnessStep / 100)
						: (h = this.colors[f], void 0 === h
								&& (h = AmCharts.randomColor())), void 0 === a[f].color
						&& (a[f].color = h);
			this.recalculatePercents()
		}
	},
	recalculatePercents : function() {
		...
		for (d = 0; d < a.length; d++)
			e = a[d], !e.hidden && 0 < e.value && (b += e.value);
		for (d = 0; d < a.length; d++)
			e = this.chartData[d], e.percents = !e.hidden && 0 < e.value ? 100
					* e.value / b : 0
	},
	...
	measureMaxLabel : function() {
		...
		for (d = 0; d < a.length; d++) {
			var e = this.formatString(this.labelText, a[d]), e = AmCharts.text(
					this.container, e, this.color, this.fontFamily,
...
AmCharts.AmXYChart = AmCharts.Class({
	...
	createValueAxes : function() {
		...
		0 === b.length
				&& (e = new AmCharts.ValueAxis, e.rotate = !1, e
						.setOrientation(!1), d.push(e), b.push(e));
		0 === a.length
				&& (e = new AmCharts.ValueAxis, e.rotate = !0, e
						.setOrientation(!0), d.push(e), a.push(e));
		for (f = 0; f < d.length; f++)
	...
	drawChart : function() {
		...
		AmCharts.ifArray(this.chartData) ? (this.chartScrollbar
				&& this.updateScrollbars(), this.zoomChart()) : this
				.cleanChart();
		if (this.hideXScrollbar) {
			var a = this.scrollbarH;
			a
					&& (this.removeListener(a, "zoomed", this.handleHSBZoom), a
							.destroy());
			this.scrollbarH = null
		}
		if (this.hideYScrollbar) {
			if (a = this.scrollbarV)
				this.removeListener(a, "zoomed", this.handleVSBZoom), a
						.destroy();
	...
	toggleZoomOutButton : function() {
		1 == this.heightMultiplier && 1 == this.widthMultiplier ? this
				.showZB(!1) : this.showZB(!0)
	},
	dispatchAxisZoom : function() {
		...
		for (b = 0; b < a.length; b++) {
			...
			if (!isNaN(d.min) && !isNaN(d.max)) {
				var e, f;
				"V" == d.orientation ? (e = d
						.coordinateToValue(-this.verticalPosition), f = d
						.coordinateToValue(-this.verticalPosition
								+ this.plotAreaHeight)) : (e = d
						.coordinateToValue(-this.horizontalPosition), f = d
						.coordinateToValue(-this.horizontalPosition
								+ this.plotAreaWidth));
				if (!isNaN(e) && !isNaN(f)) {
					if (e > f) {
						var g = f;
	...
	addChartScrollbar : function(a) {
		...
		if (a) {
			...
			var b = "backgroundColor backgroundAlpha selectedBackgroundColor selectedBackgroundAlpha scrollDuration resizeEnabled hideResizeGrips scrollbarHeight updateOnReleaseOnly"
					.split(" ");
			if (!this.hideYScrollbar) {
			...
			this.hideXScrollbar
					|| (d = new AmCharts.SimpleChartScrollbar, d.skipEvent = !0, d.chart = this, this
							.listenTo(d, "zoomed", this.handleHSBZoom), AmCharts
							.copyProperties(a, d, b), d.rotate = !1, this.scrollbarH = d)
		}
	},
	updateTrendLines : function() {
		var a = this.trendLines, b;
	...
	updateMargins : function() {
		...
		a
				&& (this.getScrollbarPosition(a, !0, this.yAxes[0].position), this
						.adjustMargins(a, !0));
		if (a = this.scrollbarH)
			this.getScrollbarPosition(a, !1, this.xAxes[0].position), this
					.adjustMargins(a, !1)
	},
	updateScrollbars : function() {
		var a = this.scrollbarV;
	...
	zoomScrollbars : function() {
		var a = this.scrollbarH;
		a
				&& a.relativeZoom(this.widthMultiplier,
	...
	handleAxisSelfZoom : function(a) {
		if ("H" == a.valueAxis.orientation) {
			...
			b = this.fitMultiplier(a.multiplier), a = -a.position * b, d = -(this.plotAreaHeight
					* b - this.plotAreaHeight), a < d && (a = d), this.verticalPosition = a, this.heightMultiplier = b;
		this.zoomChart();
		this.zoomScrollbars()
	},
	handleCursorZoom : function(a) {
		var b = this.widthMultiplier * this.plotAreaWidth / a.selectionWidth, d = this.heightMultiplier
				* this.plotAreaHeight / a.selectionHeight, b = this
				.fitMultiplier(b), d = this.fitMultiplier(d);
		this.horizontalPosition = (this.horizontalPosition - a.selectionX) * b
				/ this.widthMultiplier;
		this.verticalPosition = (this.verticalPosition - a.selectionY) * d
				/ this.heightMultiplier;
		this.widthMultiplier = b;
	...
	handleReleaseOutside : function(a) {
		...
		AmCharts.callMethod("handleReleaseOutside", [this.scrollbarH,
						this.scrollbarV])
	}
});
AmCharts.AmDraw = AmCharts.Class({
	construct : function(a, b, d) {
		...
		AmCharts.hasSVG = !!document.createElementNS
		...
		if (AmCharts.hasSVG) {
			...
			AmCharts.isIE
					...
					&& (AmCharts.VML = !0, AmCharts.vmlStyleSheet
							|| (document.namespaces.add("amvml",
									"urn:schemas-microsoft-com:vml"), b = document
									.createStyleSheet(), b
									.addRule(".amvml",
											"behavior:url(#default#VML); display:inline-block; antialias:true"), AmCharts.vmlStyleSheet = b), this.container = a, this.R = new AmCharts.VMLRenderer(this), this.R
							.disableSelection(a))
	},
	...
	setSize : function(a, b) {
		0 < a
				&& 0 < b
				&& (this.container.style.width = a + "px", this.container.style.height = b
						+ "px")
	},
	rect : function(a, b, d, e, f, g, h) {
		var j = new AmCharts.AmDObject("rect", this);
		AmCharts.VML
				&& (f = 100 * f / Math.min(d, e), d += 2 * g, e += 2 * g, j.bw = g, j.node.style.marginLeft = -g, j.node.style.marginTop = -g);
		1 > d && (d = 1);
		1 > e && (e = 1);
		j.attr({
					x : a,
	...
	bounce : function(a, b, d, e, f) {
		return (b /= f) < 1 / 2.75 ? e * 7.5625 * b * b + d : b < 2 / 2.75 ? e
				* (7.5625 * (b -= 1.5 / 2.75) * b + 0.75) + d : b < 2.5 / 2.75
				? e * (7.5625 * (b -= 2.25 / 2.75) * b + 0.9375) + d
				: e * (7.5625 * (b -= 2.625 / 2.75) * b + 0.984375) + d
	},
	...
	easeOutElastic : function(a, b, d, e, f) {
		...
		if (1 == (b /= f))
			return d + e;
		g || (g = 0.3 * f);
		h < Math.abs(e) ? (h = e, a = g / 4) : a = g / (2 * Math.PI)
				* Math.asin(e / h);
		return h * Math.pow(2, -10 * b)
				* Math.sin((b * f - a) * 2 * Math.PI / g) + e + d
	},
	renderFix : function() {
...
AmCharts.AmDObject = AmCharts.Class({
			...
			contextmenu : function(a) {
				this.node.addEventListener ? this.node.addEventListener(
						"contextmenu", a) : this.R.addListener(this,
						"contextmenu", a);
				return this
			},
			stop : function() {
				...
				(a = this.animationY)
						&& AmCharts.removeFromArray(this.R.animations, a)
			},
			length : function() {
...
AmCharts.VMLRenderer = AmCharts.Class({
	...
	create : function(a, b) {
		var d;
		if ("group" == b)
			d = document.createElement("div"), a.type = "div";
		else if ("text" == b)
			d = document.createElement("div"), a.type = "text";
		else if ("image" == b)
			d = document.createElement("img"), a.type = "image";
		else {
			a.type = "shape";
	...
	setAttr : function(a, b, d) {
		if (void 0 !== d) {
			...
			"text" == g
					&& ("text-anchor" == b
							&& (a.anchor = d, j = f.clientWidth, "end" == d
									&& (h.marginLeft = -j + "px"), "middle" == d
									&& (h.marginLeft = -(j / 2) + "px"), "start" == d
									&& (h.marginLeft = "0px")), "fill" == b
							&& (h.color = d), "font-weight" == b
							&& (h.fontWeight = d));
			if (h = a.children)
			...
			if ("shape" == g) {
				"cs" == b
						&& (f.style.width = "100px", f.style.height = "100px", f
								.setAttribute("coordsize", d));
				...
				"stroke-width" == b
						&& (e ? g.weight = d : g.setAttribute("weight", d));
				"stroke-opacity" == b
						&& (e ? g.opacity = d : g.setAttribute("opacity", d));
				"stroke-dasharray" == b
						&& (h = "solid", 0 < d && 3 > d && (h = "dot"), 3 <= d
								&& 6 >= d && (h = "dash"), 6 < d
								&& (h = "longdash"), e ? g.dashstyle = h : g
								.setAttribute("dashstyle", h));
				if ("fill-opacity" == b || "opacity" == b)
					0 === d ? e ? a.on = !1 : a.setAttribute("on", !1) : e
							? a.opacity = d
							: a.setAttribute("opacity", d);
				"fill" == b && (e ? a.color = d : a.setAttribute("color", d));
				"rx" == b
						&& (e ? f.arcSize = d + "%" : f.setAttribute("arcsize",
								d + "%"))
			}
		}
	},
	...
	setText : function(a, b) {
		var d = a.node;
		d
				&& (d.removeChild(d.firstChild), d.appendChild(document
						.createTextNode(b)));
	...
	move : function(a, b, d) {
		...
		"oval" == a.shapeType
				&& (b -= AmCharts.removePx(f.width) / 2, d -= AmCharts
						.removePx(f.height)
						/ 2);
		a = a.bw;
		isNaN(a) || (b -= a, d -= a);
		!isNaN(b) && !isNaN(d)
				&& (e.style.left = b + "px", e.style.top = d + "px")
	},
	svgPathToVml : function(a) {
		...
		for (f = 0; f < b.length; f++) {
			var g = b[f], h = g.substring(0, 1), g = g.substring(1), j = g
					.split(","), k = e(j[0]) + "," + e(j[1]);
			"M" == h && (a += " m " + k);
			"L" == h && (a += " l " + k);
			"Z" == h && (a += " x e");
	...
	updateAnimations : function() {
		...
		for (a = this.animations.length - 1; 0 <= a; a--) {
			var b = this.animations[a], d = 1E3 * b.time / AmCharts.updateRate, e = b.frame
					+ 1, f = b.obj, g = b.attribute;
			if (e <= d) {
				b.frame++;
				var h = Number(b.from), j = Number(b.to) - h, b = this.D[b.effect](
						0, e, h, j, d);
				0 === j ? this.animations.splice(a, 1) : f.node.style[g] = b
			} else
				f.node.style[g] = Number(b.to), this.animations.splice(a, 1)
		}
	},
	clipRect : function(a, b, d, e, f) {
		a = a.node;
		0 == b && 0 == d
				? (a.style.width = e + "px", a.style.height = f + "px", a.style.overflow = "hidden")
				: a.style.clip = "rect(" + d + "px " + (b + e) + "px "
						+ (d + f) + "px " + b + "px)"
	},
	rotate : function(a, b) {
		if (0 != Number(b)) {
			...
			e.backgroundColor = f;
			e.paddingLeft = 1;
			var f = b * Math.PI / 180, g = Math.cos(f), h = Math.sin(f), j = AmCharts
					.removePx(e.left), k = AmCharts.removePx(e.top), l = d.offsetWidth, d = d.offsetHeight, m = b
					/ Math.abs(b);
			e.left = j + l / 2 - l / 2 * Math.cos(f) - m * d / 2 * Math.sin(f)
					+ 3;
	...
	gradient : function(a, b, d, e) {
		...
		var g;
		for (g = 0; g < d.length; g++) {
			var h = Math.round(100 * g / (d.length - 1)), f = f
					+ (h + "% " + d[g]);
			g < d.length - 1 && (f += ",")
		}
		a = a.fill;
		90 == e ? e = 0 : 270 == e ? e = 180 : 180 == e ? e = 90 : 0 === e
				&& (e = 270);
		8 === document.documentMode ? (a.type = b, a.angle = e) : (a
				.setAttribute("type", b), a.setAttribute("angle", e));
		f && (a.colors.value = f)
	},
	remove : function(a) {
...
AmCharts.SVGRenderer = AmCharts.Class({
	...
	animate : function(a, b, d, e, f) {
		var g = this, h = a.node;
		"translate" == b
				? (h = (h = h.getAttribute("transform")) ? String(h).substring(
						10, h.length - 1) : "0,0", h = h.split(", ").join(" "), h = h
						.split(" ").join(","), 0 === h && (h = "0,0"))
				: h = h.getAttribute(b);
		b = {
			obj : a,
			frame : 0,
	...
	updateAnimations : function() {
		...
		for (a = this.animations.length - 1; 0 <= a; a--) {
			var b = this.animations[a], d = 1E3 * b.time / AmCharts.updateRate, e = b.frame
					+ 1, f = b.obj, g = b.attribute, h, j, k;
			e <= d
					? (b.frame++, "translate" == g
							? (h = b.from.split(","), g = Number(h[0]), h = Number(h[1]), j = b.to
									.split(","), k = Number(j[0]), j = Number(j[1]), k = 0 === k
									- g ? k : Math.round(this.D[b.effect](0, e,
									g, k - g, d)), b = 0 === j - h ? j : Math
									.round(this.D[b.effect](0, e, h, j - h, d)), g = "transform", b = "translate("
									+ k + "," + b + ")")
							: (h = Number(b.from), k = Number(b.to), k -= h, b = this.D[b.effect](
									0, e, h, k, d), 0 === k
									&& this.animations.splice(a, 1)), this
							.setAttr(f, g, b))
					: ("translate" == g
							? (j = b.to.split(","), k = Number(j[0]), j = Number(j[1]), f
									.translate(k, j))
							: (k = Number(b.to), this.setAttr(f, g, k)), this.animations
							.splice(a, 1))
		}
	},
	getBBox : function(a) {
	...
	clipRect : function(a, b, d, e, f) {
		...
		var j = g.parentNode;
		j
				&& (g = document.createElementNS(AmCharts.SVG_NS, "clipPath"), h = AmCharts
						.getUniqueId(), g.setAttribute("id", h), this.D.rect(b,
						d, e, f, 0, 0, g), j.appendChild(g), b = "#", AmCharts.baseHref
						&& !AmCharts.isIE && (b = window.location.href + b), this
						.setAttr(a, "clip-path", "url(" + b + h + ")"), this.clipPathC++, a.clipPath = g)
	},
	text : function(a, b, d) {
	...
	gradient : function(a, b, d, e) {
		...
		for (e = 0; e < d.length; e++)
			h = document.createElementNS(AmCharts.SVG_NS, "stop"), j = 100 * e
					/ (d.length - 1), 0 === e && (j = 0), h.setAttribute(
					"offset", j + "%"), h.setAttribute("stop-color", d[e]), b
					.appendChild(h);
