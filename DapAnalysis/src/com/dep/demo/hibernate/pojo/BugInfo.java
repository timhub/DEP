...
public class BugInfo implements java.io.Serializable {
	...
	/** full constructor */
	public BugInfo(Integer bugId, BugType bugType, Integer bugInfId,
			Integer projectId, String product, String component,
			String assignee, String status, String resolution, String summary,
			String changed, String attach1, String attach2, String attach3,
			String attach4, String attach5, String severty, String priority,
			String shotDesc, String createOn) {
		this.bugId = bugId;
